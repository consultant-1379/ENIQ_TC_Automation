...
Test disable SR parameters values are not 0 - Negative scenario
    ...
    Execute Command           sudo sed -i 's/net.ipv4.conf.all.send_redirects=0/net.ipv4.conf.all.send_redirects=1/g; s/net.ipv4.conf.default.send_redirects=0/net.ipv4.conf.default.send_redirects=1/g; s/net.ipv4.conf.all.accept_redirects=0/net.ipv4.conf.all.accept_redirects=1/g; s/net.ipv4.conf.default.accept_redirects=0/net.ipv4.conf.default.accept_redirects=1/g; s/net.ipv4.conf.all.accept_source_route=0/net.ipv4.conf.all.accept_source_route=1/g; s/net.ipv4.conf.default.accept_source_route=0/net.ipv4.conf.default.accept_source_route=1/g' /root/sysctl_backup.conf
    Log To Console            Negative Scenario contents are written to backup file
    ${negative_expected}       Execute Command         sudo grep  -e "net.ipv4.conf.all.send_redirects" -e "net.ipv4.conf.default.send_redirects" -e "net.ipv4.conf.all.accept_redirects" -e "net.ipv4.conf.default.accept_redirects" -e "net.ipv4.conf.all.accept_source_route" -e "net.ipv4.conf.default.accept_source_route" /root/sysctl_backup.conf
...
Test disable SR parameters values are 0 - Positive scenario
    ${result}=      Execute Command       sudo cat /etc/sysctl.conf | grep net.ipv4.conf.all.send_redirects
    ...
    ${result1}=      Execute Command       sudo cat /etc/sysctl.conf | grep net.ipv4.conf.default.send_redirects
    ...
    ${result2}=      Execute Command       sudo cat /etc/sysctl.conf | grep net.ipv4.conf.all.accept_redirects
    ...
    ${result3}=      Execute Command       sudo cat /etc/sysctl.conf | grep net.ipv4.conf.default.accept_redirects
    ...
    ${result4}=      Execute Command       sudo cat /etc/sysctl.conf | grep net.ipv4.conf.all.accept_source_route
    ...
    ${result5}=      Execute Command       sudo cat /etc/sysctl.conf | grep net.ipv4.conf.default.accept_source_route
    ...
    ${result6}=      Execute Command       sudo cat /etc/sysctl.conf | grep net.ipv6.conf.all.accept_source_route
    ...
    ${result7}=      Execute Command       sudo cat /etc/sysctl.conf | grep net.ipv6.conf.default.accept_source_route
    ...
    ${result8}=      Execute Command       sudo cat /etc/sysctl.conf | grep net.ipv6.conf.all.accept_redirects
    ...
    ${result9}=      Execute Command       sudo cat /etc/sysctl.conf | grep net.ipv6.conf.default.accept_redirects
...
Test disable SR is enforced in sysctl daemon - verifying system daemon
    ...
    ${sysctl_check1}=        Execute Command       sudo sysctl -n net.ipv4.conf.all.send_redirects
    Should Be Equal    ${sysctl_check1}    0
    ${sysctl_check2}=        Execute Command       sudo sysctl -n net.ipv4.conf.default.send_redirects
    Should Be Equal    ${sysctl_check2}    0    
    ${sysctl_check3}=        Execute Command       sudo sysctl -n net.ipv4.conf.all.accept_redirects
    Should Be Equal    ${sysctl_check3}    0
    ${sysctl_check4}=        Execute Command       sudo sysctl -n net.ipv4.conf.default.accept_redirects
    Should Be Equal    ${sysctl_check4}    0
    ${sysctl_check5}=        Execute Command       sudo sysctl -n net.ipv4.conf.all.accept_source_route
    Should Be Equal    ${sysctl_check5}    0
    ${sysctl_check6}=        Execute Command       sudo sysctl -n net.ipv4.conf.default.accept_source_route
    Should Be Equal    ${sysctl_check6}    0
    ${sysctl_check7}=        Execute Command       sudo sysctl -n net.ipv6.conf.all.accept_source_route
    Should Be Equal    ${sysctl_check7}    0
    ${sysctl_check8}=        Execute Command       sudo sysctl -n net.ipv6.conf.default.accept_source_route
    Should Be Equal    ${sysctl_check8}    0
    ${sysctl_check9}=        Execute Command       sudo sysctl -n net.ipv6.conf.all.accept_redirects
    Should Be Equal    ${sysctl_check9}    0
    ${sysctl_check10}=        Execute Command       sudo sysctl -n net.ipv6.conf.default.accept_redirects
