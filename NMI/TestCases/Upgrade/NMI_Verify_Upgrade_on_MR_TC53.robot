...
Checking if filesystem stats_coordinator_pool-dwh_reader ownership to dcuser:dc5000 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing filesystem stats_coordinator_pool-dwh_reader ownership to dcuser:dc5000
    
Checking if fileSystem stats_coordinator_pool-dwh_reader permissions to 0755 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing fileSystem stats_coordinator_pool-dwh_reader permissions to 0755
...
Checking if filesystem stats_coordinator_pool-dwh_main_dbspace ownership to dcuser:dc5000 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing filesystem stats_coordinator_pool-dwh_main_dbspace ownership to dcuser:dc5000
...
Checking if fileSystem stats_coordinator_pool-dwh_main_dbspace permissions to 0755 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing fileSystem stats_coordinator_pool-dwh_main_dbspace permissions to 0755
...
Checking if filesystem stats_coordinator_pool-dwh_temp_dbspace ownership to dcuser:dc5000 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing filesystem stats_coordinator_pool-dwh_temp_dbspace ownership to dcuser:dc5000
...
Checking if fileSystem stats_coordinator_pool-dwh_temp_dbspace permissions to 1755 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing fileSystem stats_coordinator_pool-dwh_temp_dbspace permissions to 1755
    
Checking if filesystem stats_coordinator_pool-misc ownership to dcuser:dc5000 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing filesystem stats_coordinator_pool-misc ownership to dcuser:dc5000
    
Checking if fileSystem stats_coordinator_pool-misc permissions to 0755 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing fileSystem stats_coordinator_pool-misc permissions to 0755
    
Checking if filesystem stats_coordinator_pool-bkup_sw ownership to dcuser:dc5000 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing filesystem stats_coordinator_pool-bkup_sw ownership to dcuser:dc5000
    
Checking if fileSystem stats_coordinator_pool-bkup_sw permissions to 0755 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing fileSystem stats_coordinator_pool-bkup_sw permissions to 0755
    
Checking if filesystem stats_coordinator_pool-connectd ownership to dcuser:dc5000 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing filesystem stats_coordinator_pool-connectd ownership to dcuser:dc5000
...
Checking if ownership of /eniq/database/dwh_main_dbspace/dbspace_dir_1 to dcuser:dc5000 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing ownership of /eniq/database/dwh_main_dbspace/dbspace_dir_1 to dcuser:dc5000
    
Checking if permissions on /eniq/database/dwh_main_dbspace/dbspace_dir_1 to 0755 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing permissions on /eniq/database/dwh_main_dbspace/dbspace_dir_1 to 0755
    
Checking if directory /eniq/database/dwh_main_dbspace/dbspace_dir_2 is successfully created on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Creating directory /eniq/database/dwh_main_dbspace/dbspace_dir_2
...
Checking if ownership of /eniq/database/dwh_main_dbspace/dbspace_dir_2 to dcuser:dc5000 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing ownership of /eniq/database/dwh_main_dbspace/dbspace_dir_2 to dcuser:dc5000
    
Checking if permissions on /eniq/database/dwh_main_dbspace/dbspace_dir_2 to 0755 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing permissions on /eniq/database/dwh_main_dbspace/dbspace_dir_2 to 0755
    
Checking if directory /eniq/database/dwh_main_dbspace/dbspace_dir_3 is successfully created on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Creating directory /eniq/database/dwh_main_dbspace/dbspace_dir_3
...
Checking if ownership of /eniq/database/dwh_main_dbspace/dbspace_dir_3 to dcuser:dc5000 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing ownership of /eniq/database/dwh_main_dbspace/dbspace_dir_3 to dcuser:dc5000
    
Checking if permissions on /eniq/database/dwh_main_dbspace/dbspace_dir_3 to 0755 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing permissions on /eniq/database/dwh_main_dbspace/dbspace_dir_3 to 0755
    
Checking if directory /eniq/database/dwh_main_dbspace/dbspace_dir_4 is successfully created on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Creating directory /eniq/database/dwh_main_dbspace/dbspace_dir_4
...
Checking if ownership of /eniq/database/dwh_main_dbspace/dbspace_dir_4 to dcuser:dc5000 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing ownership of /eniq/database/dwh_main_dbspace/dbspace_dir_4 to dcuser:dc5000
    
Checking if permissions on /eniq/database/dwh_main_dbspace/dbspace_dir_4 to 0755 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing permissions on /eniq/database/dwh_main_dbspace/dbspace_dir_4 to 0755
    
Checking if directory /eniq/database/dwh_main_dbspace/dbspace_dir_5 is successfully created on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Creating directory /eniq/database/dwh_main_dbspace/dbspace_dir_5
...
Checking if ownership of /eniq/database/dwh_main_dbspace/dbspace_dir_5 to dcuser:dc5000 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing ownership of /eniq/database/dwh_main_dbspace/dbspace_dir_5 to dcuser:dc5000
    
Checking if permissions on /eniq/database/dwh_main_dbspace/dbspace_dir_5 to 0755 on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing permissions on /eniq/database/dwh_main_dbspace/dbspace_dir_5 to 0755
    
Checking if directory /eniq/database/dwh_main_dbspace/dbspace_dir_6 is successfully created on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Creating directory /eniq/database/dwh_main_dbspace/dbspace_dir_6
...
Checking if ownership of /eniq/database/dwh_main_dbspace/dbspace_dir_6 to dcuser:dc5000 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing ownership of /eniq/database/dwh_main_dbspace/dbspace_dir_6 to dcuser:dc5000
    
Checking if permissions on /eniq/database/dwh_main_dbspace/dbspace_dir_6 to 0755 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing permissions on /eniq/database/dwh_main_dbspace/dbspace_dir_6 to 0755
    
Checking if directory /eniq/database/dwh_main_dbspace/dbspace_dir_7 is successfully created on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Creating directory /eniq/database/dwh_main_dbspace/dbspace_dir_7
...
Checking if ownership of /eniq/database/dwh_main_dbspace/dbspace_dir_7 to dcuser:dc5000 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing ownership of /eniq/database/dwh_main_dbspace/dbspace_dir_7 to dcuser:dc5000
    
Checking if permissions on /eniq/database/dwh_main_dbspace/dbspace_dir_7 to 0755 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing permissions on /eniq/database/dwh_main_dbspace/dbspace_dir_7 to 0755
    
Checking if directory /eniq/database/dwh_main_dbspace/dbspace_dir_8 is successfully created on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Creating directory /eniq/database/dwh_main_dbspace/dbspace_dir_8
...
Checking if ownership of /eniq/database/dwh_main_dbspace/dbspace_dir_8 to dcuser:dc5000 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing ownership of /eniq/database/dwh_main_dbspace/dbspace_dir_8 to dcuser:dc5000
    
Checking if permissions on /eniq/database/dwh_main_dbspace/dbspace_dir_8 to 0755 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing permissions on /eniq/database/dwh_main_dbspace/dbspace_dir_8 to 0755
    
Checking if directory /eniq/database/dwh_main_dbspace/dbspace_dir_9 is successfully created on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Creating directory /eniq/database/dwh_main_dbspace/dbspace_dir_9
...
Checking if ownership of /eniq/database/dwh_main_dbspace/dbspace_dir_9 to dcuser:dc5000 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing ownership of /eniq/database/dwh_main_dbspace/dbspace_dir_9 to dcuser:dc5000
    
Checking if permissions on /eniq/database/dwh_main_dbspace/dbspace_dir_9 to 0755 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing permissions on /eniq/database/dwh_main_dbspace/dbspace_dir_9 to 0755
    
Checking if directory /eniq/database/dwh_main_dbspace/dbspace_dir_10 is successfully created on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Creating directory /eniq/database/dwh_main_dbspace/dbspace_dir_10
...
Checking if ownership of /eniq/database/dwh_main_dbspace/dbspace_dir_10 to dcuser:dc5000 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing ownership of /eniq/database/dwh_main_dbspace/dbspace_dir_10 to dcuser:dc5000
    
Checking if permissions on /eniq/database/dwh_main_dbspace/dbspace_dir_10 to 0755 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing permissions on /eniq/database/dwh_main_dbspace/dbspace_dir_10 to 0755
    
Checking if directory /eniq/database/dwh_temp_dbspace/dbspace_dir_1 is successfully created on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Creating directory /eniq/database/dwh_temp_dbspace/dbspace_dir_1
...
Checking if ownership of /eniq/database/dwh_temp_dbspace/dbspace_dir_1 to dcuser:dc5000 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing ownership of /eniq/database/dwh_temp_dbspace/dbspace_dir_1 to dcuser:dc5000
    
Checking if permissions on /eniq/database/dwh_temp_dbspace/dbspace_dir_1 to 0755 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing permissions on /eniq/database/dwh_temp_dbspace/dbspace_dir_1 to 0755
    
Checking if directory /eniq/database/dwh_temp_dbspace/dbspace_dir_2 is successfully created on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Creating directory /eniq/database/dwh_temp_dbspace/dbspace_dir_2
...
Checking if ownership of /eniq/database/dwh_temp_dbspace/dbspace_dir_2 to dcuser:dc5000 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing ownership of /eniq/database/dwh_temp_dbspace/dbspace_dir_2 to dcuser:dc5000
    
Checking if permissions on /eniq/database/dwh_temp_dbspace/dbspace_dir_2 to 0755 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing permissions on /eniq/database/dwh_temp_dbspace/dbspace_dir_2 to 0755
    
Checking if directory /eniq/database/dwh_temp_dbspace/dbspace_dir_3 is successfully created on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Creating directory /eniq/database/dwh_temp_dbspace/dbspace_dir_3
...
Checking if ownership of /eniq/database/dwh_temp_dbspace/dbspace_dir_3 to dcuser:dc5000 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing ownership of /eniq/database/dwh_temp_dbspace/dbspace_dir_3 to dcuser:dc5000
    
Checking if permissions on /eniq/database/dwh_temp_dbspace/dbspace_dir_3 to 0755 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing permissions on /eniq/database/dwh_temp_dbspace/dbspace_dir_3 to 0755
    
Checking if directory /eniq/database/dwh_temp_dbspace/dbspace_dir_4 is successfully created on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Creating directory /eniq/database/dwh_temp_dbspace/dbspace_dir_4
...
Checking if ownership of /eniq/database/dwh_temp_dbspace/dbspace_dir_4 to dcuser:dc5000 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing ownership of /eniq/database/dwh_temp_dbspace/dbspace_dir_4 to dcuser:dc5000
    
Checking if permissions on /eniq/database/dwh_temp_dbspace/dbspace_dir_4 to 0755 is successfully changed on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Changing permissions on /eniq/database/dwh_temp_dbspace/dbspace_dir_4 to 0755
    
Checking if directory /eniq/database/dwh_temp_dbspace/dbspace_dir_5 is successfully created on coordinator
    [Tags]                        Upgrade  MR
    Should Contain                ${Content}                 Creating directory /eniq/database/dwh_temp_dbspace/dbspace_dir_5
...
Checking if required directories are successfully created on all blades
    [Tags]                        Upgrade  MR
    ${count}=                     Get Count                  ${Content}              Successfully created required directories
    Should Be Equal As Strings    ${count}                   4
    
Checking if stage - install_backup_sw is successfully entered on all blades
    [Tags]                        Upgrade  MR
    ${count}=                     Get Count                  ${Content}              Entering core install stage - install_backup_sw
    Should Be Equal As Strings    ${count}                   4
    
Checking if SW to /eniq/bkup_sw is successfully installed on all blades
    [Tags]                        Upgrade  MR
    ${count}=                     Get Count                  ${Content}              Successfully installed SW to /eniq/bkup_sw
    Should Be Equal As Strings    ${count}                   4
    
Checking if stage - install_connectd_sw is successfully entered on all blades
    [Tags]                        Upgrade  MR
    ${count}=                     Get Count                  ${Content}              Entering core install stage - install_connectd_sw
    Should Be Equal As Strings    ${count}                   4
    
Checking if SW to /eniq/connectd is successfully installed on all blades
    [Tags]                        Upgrade  MR
    ${count}=                     Get Count                  ${Content}              Successfully installed SW to /eniq/connectd
    Should Be Equal As Strings    ${count}                   4
    
Checking if stage - add_alias_details_to_service_names is successfully entered on all blades
    [Tags]                        Upgrade  MR
    ${count}=                     Get Count                  ${Content}              Entering core install stage - add_alias_details_to_service_names
    Should Be Equal As Strings    ${count}                   4
    
Checking if NAS alias information in /etc/hosts is successfully updated on all blades
    [Tags]                        Upgrade  MR
    ${count}=                     Get Count                  ${Content}              Successfully updated NAS alias information in /etc/hosts
    Should Be Equal As Strings    ${count}                   4
    
Checking if stage - install_rolling_snapshot is successfully entered on all blades
    [Tags]                        Upgrade  MR
    ${count}=                     Get Count                  ${Content}              Entering core install stage - install_rolling_snapshot
    Should Be Equal As Strings    ${count}                   4
    
Checking if rolling snapshots are successfully created on all blades
    [Tags]                        Upgrade  MR
    ${count}=                     Get Count                  ${Content}              Successfully created rolling snapshots
    Should Be Equal As Strings    ${count}                   4
    
Checking if stage - cleanup is successfully entered on all blades
    [Tags]                        Upgrade  MR
    ${count}=                     Get Count                  ${Content}              Entering core install stage - cleanup
    Should Be Equal As Strings    ${count}                   4
    
Checking if ENIQ cleanup stage is successfully completed on all blades
    [Tags]                        Upgrade  MR
    ${count}=                     Get Count                  ${Content}              Successfully completed ENIQ cleanup stage
    Should Be Equal As Strings    ${count}                   4

Checking file not found error in logs
    [Tags]		          Upgrade MR
    ${count}=                  Get Count                ${Content}                        tomcat_users_history.properties: No such file or directory
    Should Contain X Times     ${Content}               No such file or directory         ${count}
