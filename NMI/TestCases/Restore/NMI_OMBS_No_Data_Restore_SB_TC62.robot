...
Checking user input for server information
    [Tags]                    Restore   Rack
    ${NO_DATA_Restore}=        Get File                        OMBS-No-Data-Restore-SB.log
...
Checking user confirmation for server information
    [Tags]                    Restore   Rack
    Should Contain            ${NO_DATA_Restore}                ENIQ_Statistics_Single_Blade
    
Checking restore started on Single Blade
    [Tags]                    Restore   Rack
    Should Contain            ${NO_DATA_Restore}            Starting restore on  eniq_stats
...
Checking o_restore_raw stage entered
    [Tags]                    Restore   Rack
    Should Contain            ${NO_DATA_Restore}            Skipping this stage,it is only applicable for FullData restore
