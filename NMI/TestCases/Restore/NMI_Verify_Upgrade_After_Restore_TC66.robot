...
Checking if stage list is successfully built
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Building stage list from /eniq/installation/core_install/etc/stats_eniq_stats_stagelist
...
Checking if unpacking core SW is successfully finished
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Successfully finished unpacking core SW
...
Checking if precheck - CHECK_STORAGE_IP is successfully started
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Precheck started for CHECK_STORAGE_IP
	
Checking if precheck - CHECK_STORAGE_IP is successfully completed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Precheck completed for CHECK_STORAGE_IP
	
Checking if precheck - NAS_ONLINE is successfully started
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Precheck started for NAS_ONLINE
	
Checking if precheck - NAS_ONLINE is successfully completed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Precheck completed for NAS_ONLINE
	
Checking if precheck - CORE_DUMP_CHECK is successfully started
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Precheck started for CORE_DUMP_CHECK
	
Checking if precheck - CORE_DUMP_CHECK is successfully completed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Precheck completed for CORE_DUMP_CHECK
...
Checking if precheck - ENIQ_SERVICES is successfully started
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Precheck started for ENIQ_SERVICES
	
Checking if precheck - ENIQ_SERVICES is successfully completed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Precheck completed for ENIQ_SERVICES
	
Checking if precheck - FILESYSTEM is successfully started
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Precheck started for FILESYSTEM
	
Checking if precheck - FILESYSTEM is successfully completed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Precheck completed for FILESYSTEM
...
Checking if precheck - OSS_MOUNT is successfully started
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Precheck started for OSS_MOUNT
	
Checking if precheck - OSS_MOUNT is successfully completed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Precheck completed for OSS_MOUNT
	
Checking if precheck - INODES is successfully started
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Precheck started for INODES
	
Checking if precheck - INODES is successfully completed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Precheck completed for INODES
...
Checking if precheck - CRASH_DUMP is successfully started
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Precheck started for CRASH_DUMP
	
Checking if precheck - CRASH_DUMP is successfully completed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Precheck completed for CRASH_DUMP
	
Checking if precheck - VG_STATUS is successfully started
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Precheck started for VG_STATUS
	
Checking if precheck - VG_STATUS is successfully completed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Precheck completed for VG_STATUS
	
Checking if precheck - DIRECTORY_PERMS is successfully started
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Precheck started for DIRECTORY_PERMS
	
Checking if precheck - DIRECTORY_PERMS is successfully completed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Precheck completed for DIRECTORY_PERMS
...
Checking if precheck - MESSAGES_LOGS is successfully started
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Precheck started for MESSAGES_LOGS
	
Checking if precheck - MESSAGES_LOGS is successfully completed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Precheck completed for MESSAGES_LOGS
...
Checking if precheck - SNAPSHOT_CACHE_FS is successfully started
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Precheck started for SNAPSHOT_CACHE_FS
	
Checking if precheck - SNAPSHOT_CACHE_FS is successfully completed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Precheck completed for SNAPSHOT_CACHE_FS
...
Checking if stage - update_dwh_reader is successfully entered
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Entering Upgrade stage - update_dwh_reader
...
Checking if new package ERICstmnas is successfully installed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Successfully Installed new package ERICstmnas
	
Checking if NAS API is successfully installed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Successfully installed NAS API
...
Checking if ENIQ SentinelLM installation script is successfully completed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Successfully completed ENIQ SentinelLM installation script
...
Checking if stage - update_sysuser_file is successfully entered
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Entering core install stage - update_sysuser_file
	
Checking if stage - update_sysuser_file is successfully completed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Successfully completed core install stage - update_sysuser_file
...
Checking if filesystem eniq_stats_pool-rep_main ownership to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing filesystem eniq_stats_pool-rep_main ownership to dcuser:dc5000
	
Checking if fileSystem eniq_stats_pool-rep_main permissions to 0755 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing fileSystem eniq_stats_pool-rep_main permissions to 0755
	
Checking if filesystem eniq_stats_pool-rep_temp ownership to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing filesystem eniq_stats_pool-rep_temp ownership to dcuser:dc5000
	
Checking if fileSystem eniq_stats_pool-rep_temp permissions to 1755 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing fileSystem eniq_stats_pool-rep_temp permissions to 1755
	
Checking if filesystem eniq_stats_pool-dwh_main ownership to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing filesystem eniq_stats_pool-dwh_main ownership to dcuser:dc5000
	
Checking if fileSystem eniq_stats_pool-dwh_main permissions to 0755 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing fileSystem eniq_stats_pool-dwh_main permissions to 0755
	
Checking if filesystem eniq_stats_pool-dwh_reader ownership to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing filesystem eniq_stats_pool-dwh_reader ownership to dcuser:dc5000
	
Checking if fileSystem eniq_stats_pool-dwh_reader permissions to 0755 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing fileSystem eniq_stats_pool-dwh_reader permissions to 0755
	
Checking if filesystem eniq_stats_pool-dwh_main_dbspace ownership to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing filesystem eniq_stats_pool-dwh_main_dbspace ownership to dcuser:dc5000
	
Checking if fileSystem eniq_stats_pool-dwh_main_dbspace permissions to 0755 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing fileSystem eniq_stats_pool-dwh_main_dbspace permissions to 0755
	
Checking if filesystem eniq_stats_pool-dwh_temp_dbspace ownership to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing filesystem eniq_stats_pool-dwh_temp_dbspace ownership to dcuser:dc5000
	
Checking if fileSystem eniq_stats_pool-dwh_temp_dbspace permissions to 1755 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing fileSystem eniq_stats_pool-dwh_temp_dbspace permissions to 1755
	
Checking if filesystem eniq_stats_pool-misc ownership to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing filesystem eniq_stats_pool-misc ownership to dcuser:dc5000
	
Checking if fileSystem eniq_stats_pool-misc permissions to 0755 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing fileSystem eniq_stats_pool-misc permissions to 0755
	
Checking if filesystem eniq_stats_pool-bkup_sw ownership to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing filesystem eniq_stats_pool-bkup_sw ownership to dcuser:dc5000
	
Checking if fileSystem eniq_stats_pool-bkup_sw permissions to 0755 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing fileSystem eniq_stats_pool-bkup_sw permissions to 0755
	
Checking if filesystem eniq_stats_pool-connectd ownership to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing filesystem eniq_stats_pool-connectd ownership to dcuser:dc5000
	
Checking if fileSystem eniq_stats_pool-connectd permissions to 0755 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing fileSystem eniq_stats_pool-connectd permissions to 0755
	
Checking if filesystem eniq_stats_pool-installation ownership to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing filesystem eniq_stats_pool-installation ownership to dcuser:dc5000
	
Checking if fileSystem eniq_stats_pool-installation permissions to 0755 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing fileSystem eniq_stats_pool-installation permissions to 0755
	
Checking if filesystem eniq_stats_pool-smf ownership to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing filesystem eniq_stats_pool-smf ownership to dcuser:dc5000
	
Checking if fileSystem eniq_stats_pool-smf permissions to 0755 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing fileSystem eniq_stats_pool-smf permissions to 0755
	
Checking if filesystem eniq_stats_pool-local_logs ownership to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing filesystem eniq_stats_pool-local_logs ownership to dcuser:dc5000

Checking if fileSystem eniq_stats_pool-local_logs permissions to 0755 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing fileSystem eniq_stats_pool-local_logs permissions to 0755
...
Checking if ownership of /eniq/data/pushData to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing ownership of /eniq/data/pushData to dcuser:dc5000
...
Checking if ownership of /eniq/data/pushData/00 to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing ownership of /eniq/data/pushData/00 to dcuser:dc5000
...
Checking if ownership of /eniq/data/pushData/01 to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing ownership of /eniq/data/pushData/01 to dcuser:dc5000
...
Checking if ownership of /eniq/data/pushData/02 to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing ownership of /eniq/data/pushData/02 to dcuser:dc5000
...
Checking if ownership of /eniq/data/pushData/03 to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing ownership of /eniq/data/pushData/03 to dcuser:dc5000
...
Checking if ownership of /eniq/data/pushData/04 to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing ownership of /eniq/data/pushData/04 to dcuser:dc5000
...
Checking if ownership of /eniq/data/pushData/05 to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing ownership of /eniq/data/pushData/05 to dcuser:dc5000
...
Checking if ownership of /eniq/data/pushData/06 to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing ownership of /eniq/data/pushData/06 to dcuser:dc5000
...
Checking if ownership of /eniq/data/pushData/07 to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing ownership of /eniq/data/pushData/07 to dcuser:dc5000
...
Checking if ownership of /eniq/data/pushData/08 to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing ownership of /eniq/data/pushData/08 to dcuser:dc5000
...
Checking if ownership of /eniq/data/pushData/09 to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing ownership of /eniq/data/pushData/09 to dcuser:dc5000
...
Checking if ownership of /eniq/data/pushData/10 to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing ownership of /eniq/data/pushData/10 to dcuser:dc5000
...
Checking if ownership of /eniq/data/pushData/11 to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing ownership of /eniq/data/pushData/11 to dcuser:dc5000
...
Checking if ownership of /eniq/data/pushData/12 to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing ownership of /eniq/data/pushData/12 to dcuser:dc5000
...
Checking if ownership of /eniq/data/pushData/13 to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing ownership of /eniq/data/pushData/13 to dcuser:dc5000
...
Checking if ownership of /eniq/data/pushData/14 to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing ownership of /eniq/data/pushData/14 to dcuser:dc5000
...
Checking if ownership of /eniq/data/pushData/15 to dcuser:dc5000 is successfully changed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Changing ownership of /eniq/data/pushData/15 to dcuser:dc5000
...
Checking if directory /eniq/data/pmdata_sim is successfully created
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Creating directory /eniq/data/pmdata_sim
...
Checking if stage - install_backup_sw is successfully entered
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Entering core install stage - install_backup_sw
	
Checking if SW to /eniq/bkup_sw is successfully installed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Successfully installed SW to /eniq/bkup_sw
	
Checking if stage - install_connectd_sw is successfully entered
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Entering core install stage - install_connectd_sw
	
Checking if SW to /eniq/connectd is successfully installed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Successfully installed SW to /eniq/connectd
	
Checking if stage - add_alias_details_to_service_names is successfully entered
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Entering core install stage - add_alias_details_to_service_names
	
Checking if NAS alias information in /etc/hosts is successfully updated
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Successfully updated NAS alias information in /etc/hosts
	
Checking if stage - install_rolling_snapshot is successfully entered
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Entering core install stage - install_rolling_snapshot
	
Checking if rolling snapshots are successfully created
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Successfully created rolling snapshots
	
Checking if stage - cleanup is successfully entered
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Entering core install stage - cleanup
	
Checking if ENIQ cleanup stage is successfully completed
    [Tags]             Restore   Upgrade
    ${Content}=        Get File                   Restore-Upgrade.log
    Should Contain     ${Content}                 Successfully completed ENIQ cleanup stage
