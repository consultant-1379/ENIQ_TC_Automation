...
Checking user input for server information
    [Tags]                    Restore   Rack
    ${FULL_DATA_Restore}=     Get File                        OMBS-Full-Data-Restore-Rack.log
...
Checking user confirmation for server information
    [Tags]                    Restore   Rack
    Should Contain            ${FULL_DATA_Restore}            ENIQ_Statistics_Rack_Server
    
Checking restore started on Rack
    [Tags]                    Restore   Rack
