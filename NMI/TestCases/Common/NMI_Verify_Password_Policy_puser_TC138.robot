...
DC Password should be of length 5-30
    [Tags]                      II
    Set Client Configuration    timeout=25 seconds            prompt=#:
    ${value}=                   Execute Command               sudo cat /eniq/installation/config/niq.ini | grep DCPassword= | cut -f1 -d'=' --complement | head -1
    ${state}=                   Execute Command               sudo cat /eniq/installation/config/niq.ini | grep DCPassword_Encrypted= | cut -f1 -d'=' --complement | head -1
    ${strong_passphase}=        Execute Command               sudo cat /eniq/sw/conf/strong_passphrase
...
DCBO Password should be of length 5-30
    [Tags]                      II
    Set Client Configuration    timeout=25 seconds            prompt=#:
    ${value}=                   Execute Command               sudo cat /eniq/installation/config/niq.ini | grep DCBOPassword= | cut -f1 -d'=' --complement | head -1
    ${state}=                   Execute Command               sudo cat /eniq/installation/config/niq.ini | grep DCBOPassword_Encrypted= | cut -f1 -d'=' --complement | head -1
    ${strong_passphase}=        Execute Command               sudo cat /eniq/sw/conf/strong_passphrase
...
DCPUBLIC Password should be of length 5-30
    [Tags]                      II
    Set Client Configuration    timeout=25 seconds            prompt=#:
    ${value}=                   Execute Command               sudo cat /eniq/installation/config/niq.ini | grep DCPUBLICPassword= | cut -f1 -d'=' --complement | head -1
    ${state}=                   Execute Command               sudo cat /eniq/installation/config/niq.ini | grep DCPUBLICPassword_Encrypted= | cut -f1 -d'=' --complement | head -1
    ${strong_passphase}=        Execute Command               sudo cat /eniq/sw/conf/strong_passphrase
...
ETLREP Password should be of length 5-30
    [Tags]                      II
    Set Client Configuration    timeout=25 seconds            prompt=#:
    ${value}=                   Execute Command               sudo cat /eniq/installation/config/niq.ini | grep ETLREPPassword= | cut -f1 -d'=' --complement | head -1
...
DCUSER Password should be of length 9-30
    [Tags]                      II
    Set Client Configuration    timeout=25 seconds            prompt=#:
    ${value1}=                  Execute Command               sudo cat /eniq/sw/conf/dcuser_password_file
    ${value2}=                  Execute Command               sudo cat /eniq/sw/conf/strong_passphrase
    ${pwd}=                     Execute Command               sudo echo '${value1}' | openssl enc -aes-256-ctr -md sha512 -a -d -salt -pass pass:${value2}
