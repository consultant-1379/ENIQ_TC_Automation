...
Checking if User selected option is FullData
    [Tags]             OMBS  B&R  
    Should Contain     ${OMBS}                 User selected option is FullData
...
Checking if crontab successfully updated
    [Tags]             OMBS  B&R  
    Should Contain     ${OMBS}                 in crontab
...
Installing NBU client software in ENIQ Backup Policy process
    [Tags]             OMBS  B&R    
    Should Contain     ${OMBS}                 NBU client software
