...
Checking if migration started successfully.
    ...
    ${Blade_Migration}=    Get File                      Migration-MB.log
...
Checking if Linux migration stage - update_cron_file is successfully started.
    [Tags]             Blade  Migration    
    Should Contain     ${Blade_Migration}                 Entering Linux migration stage - update_cron_file
	
Checking if Linux migration stage - update_cron_file is successfully completed.
    [Tags]             Blade  Migration    
    Should Contain     ${Blade_Migration}                 Successfully completed - update_cron_file
