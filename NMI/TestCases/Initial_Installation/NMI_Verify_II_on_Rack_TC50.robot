...
Checking if bond information is successfully skipped
    [Tags]             II  Rack
    Should Contain     ${II_Rack_Log}                 FS Install - Skipping core install stage - get_ipmp_info
...
Checking if bond setup stage is successfully skipped
    [Tags]             II  Rack
    Should Contain     ${II_Rack_Log}                 FS Install - Skipping core install stage - setup_ipmp
...
Checking if installation type prompt is successfully displayed
    [Tags]             II  Rack
    Should Contain     ${II_Rack_Log}                 Select the ip type you wish to install
