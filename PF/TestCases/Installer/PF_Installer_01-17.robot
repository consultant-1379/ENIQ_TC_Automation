...
TC_15 Verify the Change the keystore password and check the four files and verify the passwords in Keystore passwords
    Connect to server as a dcuser
...
TC_16 Verify the root user change verification.
    Open connection as root user
    ${random_password_generated}=    random_generating_complaint_passwords
    Log To Console    ${random_password_generated}
