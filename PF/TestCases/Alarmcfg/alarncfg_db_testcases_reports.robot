...
${5min_almrpt_name}    AlarmInterface_15min
...
Functional verification 15min alarm type -report loading verification in DB
    ...
    # Write   echo -e "Select ROWSTATUS from DC_Z_ALARM_INFO_RAW where ReportTitle='${almcfg_5min_almrpt_id}' and TIMELEVEL='15MIN' and DATE_ID='${almcfg_current_date}';\ngo\n" | dbisql -n -c "UID=dc;PWD=${dc_pwd};eng=dwhdb" -host localhost -port 2640 -nogui
