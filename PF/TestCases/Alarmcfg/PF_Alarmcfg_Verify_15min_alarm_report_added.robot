...
${15min_alm_template_db}    AM_Static_Threshold_Template_AUTOMATION-MTAS-1
${15min_basetable_db}    DC_E_MTAS_MTASLICENSES_RAW
...
Verify 15min Interface Alarm report addition
    ...
    Select alarm template from available reports    ${15min_alm_template_db}
    Select basetable from dropdown list    ${15min_basetable_db}
    Click Add alarm report button
    Verify alarm report addition     ${15min_basetable_db}    ${15min_alm_template_db}
