...
${10min_alm_template_db}    AUTOMATION_NR_GNBDUFUNCTION_10MIN
${10min_basetable_db}    DC_E_NR_GNBDUFUNCTION_RAW
${10min_almrpt_name}    AlarmInterface_10min
${reports_alarmname_db}    AUTOMATION_NR_GNBDUFUNCTION_10MIN

*** Test Cases ***
Verify 10min alarmreport status is active 
...
Functional verification 10min alarm type -report parsing verification in file logs
...
Functional verification 10min alarm type -report loading verification in DB
    Skip if    '${PREV TEST STATUS}'=='FAIL' or '${PREV TEST STATUS}'=='SKIP'
