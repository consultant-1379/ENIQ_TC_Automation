...
${5min_alm_template_db}    AUTOMATION_NR_GNBCUCPFUNCTION_5MIN
${5min_basetable_db}    DC_E_NR_GNBCUCPFUNCTION_RAW
${5min_almrpt_name}    AlarmInterface_5min
${reports_alarmname_db}    AUTOMATION_NR_GNBCUCPFUNCTION_5MIN
