...
${30min_alm_template_db}    AUTOMATION_NR_NRCELLDU_30MIN
${30min_basetable_db}    DC_E_NR_NRCELLDU_RAW
${30min_almrpt_name}    AlarmInterface_30min
${reports_alarmname_db}    AUTOMATION_NR_NRCELLDU_30MIN

*** Test Cases ***
Verify 30min alarmreport status is active 
...
Functional verification 30min alarm type -report parsing verification in file logs
...
Functional verification 30min alarm type -report loading verification in DB
    Skip if    '${PREV TEST STATUS}'=='FAIL' or '${PREV TEST STATUS}'=='SKIP'
