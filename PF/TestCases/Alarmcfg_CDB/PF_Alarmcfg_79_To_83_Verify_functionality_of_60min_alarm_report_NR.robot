...
${60min_alm_template_db}    AUTOMATION_NR_NRSECTORCARRIER_60MIN
${60min_basetable_db}    DC_E_NR_NRSECTORCARRIER_RAW
${60min_almrpt_name}    AlarmInterface_60min
${reports_alarmname_db}    AUTOMATION_NR_NRSECTORCARRIER_60MIN

*** Test Cases ***
Verify 60min alarmreport status is active 
...
Functional verification 60min alarm type -report parsing verification in file logs
...
Functional verification 60min alarm type -report loading verification in DB
    Skip if    '${PREV TEST STATUS}'=='FAIL' or '${PREV TEST STATUS}'=='SKIP'
