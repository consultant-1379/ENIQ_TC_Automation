...
${rd_alm_template_db}    AUTOMATION_NR_NRCELLCU_RD
${rd_basetable_db}    DC_E_NR_NRCELLCU_RAW
${rd_almrpt_name}    AlarmInterface_RD
${reports_alarmname_db}    AUTOMATION_NR_NRCELLCU_RD

*** Test Cases ***
Verify reduced delay alarmreport status is active 
...
Functional verification reduced delay alarm type -report parsing verification in file logs
...
Functional verification reduced delay alarm type -report loading verification in DB
    Skip if    '${PREV TEST STATUS}'=='FAIL' or '${PREV TEST STATUS}'=='SKIP'
