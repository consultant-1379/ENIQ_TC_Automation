...
Verify 5min Interface Alarm report addition
    ...
    Verify target reports are not added    ${cdb_basetable}    ${cdb_alm_template}    5min
    ...
    ${alm_report_status}=    Verify alarm report addition    ${cdb_basetable}    ${cdb_alm_template} 
