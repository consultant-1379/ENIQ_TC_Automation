...
###############################################################
	...
	for ($i=0;$i<$count;$i++) {
		...
		my %PmGenNodes = (
				...
				"SMPC" => ["smpcGenFlag"],
				"GMPC" => ["gmpcGenFlag"],
				"ERBS" => ["lteEventGenFlag","wranLteGenFlag","erbsg2GenFlag"],
				...
				"SMSF" => ["SMSFGenFlag"],
				"SC" => ["SCGenFlag"],
				"CUDB" => ["cudbGenFlag" , "EirFeGenFlag","CCDMGenFlag"],
				"SCEF" => ["scefGenFlag"],
				...
				"WCG" => ["WcgGenFlag"],
				"vEME" => ["vEMEGenFlag"],
				"VPP" => ["vPPGenFlag","5GRadioNodeGenFlag"],
		...
		my %PmDirList = (
				...
				"cRAN" => ["SharedCNFTopo/topologyData/SharedCNFTopo"],
				"BBSC" => [""],
				"CMN_STS" =>  [""],		 	
				"CMN_STS_PC" =>  [""],	 			 	
				"CN_TOP" =>  [""],
