...
###############################################################
	...
	for ($i=0;$i<$count;$i++) {
		...
		my %PmDirList = (
				...
				"PCC" => ["5GCORE/PCC"],
				"PCG" => ["5GCORE"],
				"NRFAGENT" => ["5GCORE/NRFAGENT"],
				"CONTROLLER" => ["transport/topologyData/CONTROLLER"],
				...
				"CN" => ["core/topologyData/CoreNetwork","5GCORE"],
				...
				"MGW"	=> ["core/topologyData/CoreNetwork/CELLO"],		 		 		 		 	
				...
				"IPTNMS_TOP" => [""], 
				"SHARED_CNF" => ["SharedCNFTopo/topologyData/SharedCNFtopo"],		 	
				"IPTRANSPORT_TOP" => [""],
				"OCC" => [""],				 	
				"SOEM_MBH" => [""],		 			 			 		 	
				"TSS" => ["tss/topologyData"],	 	
				"TSSAXD" => [""],	 		 	
				"TSS_TGC" => [""],	 	
				"TSS_TOP" => [""],		 	
				"UDM" => [""],	 	
