...
my ($secs,$mins,$hours,$mdays,$mons,$years,$wdays, $ydays,$isdsts)=localtime( time );
$mons++;
$years=1900+$years;
my $todayDate = sprintf "%02d-%02d-%4d", $mdays,$mons,$years;
...
###############################################################
	...
	for ($i=0;$i<$count;$i++) {
		...
		my %PmGenNodes = (
				...
				"RNC" => ["rncGenFlag"],
				"BSS" => ["bscApgGenFlag" , "bsclogGenFlag" , "ebagBscGenFlag" , "BssEventGenFlag" , "GSMMixModeOffGenFlag"],
				"RBS" => ["wranRBSGenFlag" , "RBSG2GenFlag"],
				...
				"CSCF" => ["vcscfGenFlag" , "cscfGenFlag"],
				"SMPC" => ["smpcGenFlag"],
				"GMPC" => ["gmpcGenFlag"],
				"ERBS" => ["lteEventGenFlag","wranLteGenFlag"],
				"FFAX" => ["lteEventGenFlag","wranLteGenFlag" , "erbsg2GenFlag" , "RadioNodeMixedGenFlag"],
				"FFAXW" => ["wranRBSGenFlag" , "RBSG2GenFlag"],
				"REDB" => ["smartMetroGenFlag"],
				"MGC" => ["mgcGenFlag"], 
				"CNAXE" => ["hlrBsGenFlag" , "mscApgGenFlag" , "bscApgGenFlag" ,"bscIogGenFlag" , "mscApgOmsGenFlag" , "mscIogGenFlag" , "mscIogOmsGenFlag" , "mscBcGenFlag" , "mscBcOmsGenFlag" , "hlrApgGenFlag" , "hlrIogGenFlag"],
				"BBSC" => ["bbscGenFlag"],
				"CCDM" => ["CCDMGenFlag"],
				"CCRC" => ["CCRCGenFlag"],
				"CCSM" => ["CCSMGenFlag"],
				...
				"CCPC" => ["CCPCGenFlag"],
				"CCES" => ["CCESGenFlag"],
				"IPTRANSPORT" => ["spitfireGenFlag","ipTransportGenFlag","FrontHaulGenFlag","MinilinkOutdoorGenFlag","MiniLinkIndoorSNMPGenFlag" , "MinilinkoutdoorSwitchGenFlag" , "MinilinkOutdoorGenFlag","MinilinkBulkpmGenFlag"],
				"JUNOS" => ["JUNIPERGenFlag"],
				"MRS" => ["mrsGenFlag","MRSvGenFlag" , "vBGFGenFlag"],
				...
				"BTSG2" => ["RadioNodeMixedGenFlag" , "GSMG2GenFlag" , "GSMG2GenFlag"],
				"RNC" => ["rncGenFlag"],
				"CPP" => ["rncGenFlag" , "wranRXIGenFlag" , "wranRBSGenFlag","wranLteGenFlag" , "RbsGenFlag" , "RxiGenFlag"],
				"RXI" => ["wranRXIGenFlag"],
				"TSSAXE" => ["TSSAXEASNAPGGenFlag" , "TSSAXEASNIOGGenFlag" , "TSSAXEASNOmsGenFlag" , "TSSAXE3gppGenFlag"],
				"UDM" => ["UdmGenFlag"],
				"CONTROLLER" => ["ControllerGenFlag"],
				"CMN_STS" => ["GSMMixModeOffGenFlag" , "bscApgGenFlag" , "bscIogGenFlag" , "BssEventGenFlag"],
				"UPG" => ["upgGenFlag"],
				"WCG" => ["WcgGenFlag"],
				"vEME" => ["vEMEGenFlag"],
				"vPP" => ["vPPGenFlag"],
				"RAN" => ["rncGenFlag" , "wranRBSGenFlag"],
				...
				"cBGF" => ["cIMSGenFlag"],
				"cSBG" => ["cIMSGenFlag"],
				"NRFAGENT" => ["CCSMGenFlag" , "CCDMGenFlag" , "CCRCGenFlag" , "CCESGenFlag" , "CCPCGenFlag"],
				"PRBS_CPP" => ["PRBSGenFlag"],
				"PRBS_ERBS"	 => ["PRBSGenFlag"],	 	
				"PRBS_RBS" => ["PRBSGenFlag" , "wranRBSGenFlag"],
			);
		...
		if ( $d =~ m/(^DC_\w*)/ ) {	
			...
			if ($string ~~ @keys){
				...
				for ($j=0;$j<$count1;$j++){
					...
					my $newStartTime = $flagName."StartTime=".$todayDate."-10:00\n";
					
					my $oldEndTime = $flagName."EndTime=";
					print "endtime is $oldEndTime\n";
					my $newEndTime = $flagName."EndTime=".$todayDate."-12:00\n";
