...
Verifying Health Check-PUSCH Analysis Page Charts for Average Noise Rise
	[Tags]    NR_Uplink_Interference_CDB    NRUI_TC_16
	...
	Verify that the charts on Health Check-PUSCH/PRB Analysis are named for    Noise Rise    Average
