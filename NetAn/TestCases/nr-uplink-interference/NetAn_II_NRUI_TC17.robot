...
Verifying Health Check-PUSCH Detailed Analysis Page Charts
	[Tags]    NR_Uplink_Interference_CDB    NRUI_TC_17
	...
	Verify that the charts on Health Check-PUSCH/PRB Analysis are named for    Interference Power    Average
