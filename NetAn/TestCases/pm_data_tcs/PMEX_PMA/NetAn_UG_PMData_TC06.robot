...
Verify That The New counters for 24.1 iteration 1 Is Present In PMEx
	[Tags]   PMD_CDB               NetAn_UG_PMData_TC06
    ${json}=    OperatingSystem.get file    ./ENIQ_TC_Automation/NetAn/Resources/Data/pm-data/24.1_Iteration_1_PMEx_Counters.json    #replace POC.json with the JSON file created using Data_Set_Generator_For_PMEX#
