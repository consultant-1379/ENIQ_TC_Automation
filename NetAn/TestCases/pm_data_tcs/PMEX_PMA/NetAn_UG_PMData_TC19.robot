...
Verify That The New Measure Is Present In PMA
	[Tags]    PMD_CDB	EQEV-125465      NetAn_UG_PMData_TC19
    ${json}=    OperatingSystem.get file    ./ENIQ_TC_Automation/NetAn/Resources/Data/pm-data/24.2_Iteration_2_PMA_KPI.json    #replace POC.json with the JSON file created using Data_Set_Generator_For_PMA.robot#
