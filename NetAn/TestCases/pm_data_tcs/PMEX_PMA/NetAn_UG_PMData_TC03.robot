...
Verify That The New counters for 24.1 iteration 2 Is Present In PMA
	[Tags]     PMD_CDB               NetAn_UG_PMData_TC03
    ${json}=    OperatingSystem.get file    ./ENIQ_TC_Automation/NetAn/Resources/Data/pm-data/24.1_PMA_Counters.json    #replace POC.json with the JSON file created using Data_Set_Generator_For_PMA.robot#
