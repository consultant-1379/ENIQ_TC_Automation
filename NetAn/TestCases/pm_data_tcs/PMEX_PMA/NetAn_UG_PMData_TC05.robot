...
Verify That The New Counters for 24.1 iteration 1 Is Present In PMA
	[Tags]    PMD_CDB               NetAn_UG_PMData_TC05
    ${json}=    OperatingSystem.get file    ./ENIQ_TC_Automation/NetAn/Resources/Data/pm-data/24.1_Iteration_1_PMA_Counters.json    #replace POC.json with the JSON file created using Data_Set_Generator_For_PMA.robot#
