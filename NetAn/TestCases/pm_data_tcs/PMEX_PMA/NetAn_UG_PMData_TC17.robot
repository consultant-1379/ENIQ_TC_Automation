...
Verify That The New Measure Is Present In PMEx
	[Tags]    PMD_CDB
    ${json}=    OperatingSystem.get file    ./ENIQ_TC_Automation/NetAn/Resources/Data/pm-data/24.2_Iteration_1_PMEx_KPI.json    #replace POC.json with the JSON file created using Data_Set_Generator_For_PMEX#
