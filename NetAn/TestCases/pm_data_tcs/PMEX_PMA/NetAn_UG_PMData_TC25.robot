...
Verify That The New Measure Is Present In PMEx
	[Tags]    PMD_CDB	EQEV-124492      NetAn_UG_PMData_TC25
    ${json}=    OperatingSystem.get file    ./ENIQ_TC_Automation/NetAn/Resources/Data/pm-data/24.3_Iteration_1_PMEx_Counters.json    #replace POC.json with the JSON file created using Data_Set_Generator_For_PMEX#
