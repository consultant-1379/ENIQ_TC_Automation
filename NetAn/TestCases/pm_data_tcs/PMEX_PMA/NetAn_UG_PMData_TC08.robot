...
Verify That The New KPIs for 24.1 iteration 2 Is Present In PMEx
	[Tags]      PMD_CDB            NetAn_UG_PMData_TC08
    ${json}=    OperatingSystem.get file    ./ENIQ_TC_Automation/NetAn/Resources/Data/pm-data/24.1_PMEx_KPI.json    #replace POC.json with the JSON file created using Data_Set_Generator_For_PMEX#
