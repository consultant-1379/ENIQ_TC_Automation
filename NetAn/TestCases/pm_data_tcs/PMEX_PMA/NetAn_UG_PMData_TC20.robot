...
Verify That The New Measure Is Present In PMEx
	[Tags]    PMD_CDB	EQEV-125465      NetAn_UG_PMData_TC20
    ${json}=    OperatingSystem.get file    ./ENIQ_TC_Automation/NetAn/Resources/Data/pm-data/24.2_Iteration_2_PMEx_Counters.json    #replace POC.json with the JSON file created using Data_Set_Generator_For_PMEX#
...
Verify That The New Measure Is Present In PMEx
    ...
    Click on scroll up button         9        30 
