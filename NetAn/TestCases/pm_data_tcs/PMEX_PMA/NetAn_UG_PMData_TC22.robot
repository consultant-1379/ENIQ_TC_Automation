...
Verify Alarm creation in PMA for for NR Counters
	[Tags]    PMD_CDB	EQEV-125465      NetAn_UG_PMData_TC22
    ${json}=    OperatingSystem.get file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/pm-alarm/FlexDynV_PMA_DataIntergerity.json
...
Verify alarm generation for threshold alarm
    ...
    Verify integrity of new counter      ${data}[Measure]     ${data}[SQL1]        ${data}[SQL2]        ${data}[SQL3]        ${data}[SQL4]      
