...
Suite setup       Suite setup steps for pmalarm for pmdata
Suite teardown    Suite teardown steps for pmalarm
#Test setup        Navigate to PMEX home page
Test teardown      Test teardown steps for pmalarm

*** Test Cases ***

Verify That The New KPIs for 24.1 iteration 1 Is Present In PMA
	[Tags]     PMD_CDB               NetAn_UG_PMData_TC01
    ${json}=    OperatingSystem.get file    ./ENIQ_TC_Automation/NetAn/Resources/Data/pm-data/24.1_Iteration_1_PMA_KPI.json    #replace POC.json with the JSON file created using Data_Set_Generator_For_PMA.robot#
