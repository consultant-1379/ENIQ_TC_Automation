...
Documentation     Check the Report Is Generated for Custom Flex KPI if there is no data 
...
Check the Report Is Generated for Custom Flex KPI if there is no data
