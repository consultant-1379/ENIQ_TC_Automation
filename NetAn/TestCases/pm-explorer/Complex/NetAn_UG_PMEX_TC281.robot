*** Settings ***
Documentation     Verify report creation for'Calendar Interval', 'All Selected' and 'Nodes'
...
Verify Report creation in PMEX with data 'Calendar Interval', 'All Selected' and 'Nodes'
    [Tags]       PMEX      Report_Manager
    ${json}=    OperatingSystem.get file    ./ENIQ_TC_Automation/NetAn/Resources/Data/pm-explorer/PMExWebUIReport_CalendarInterval_All_Selected_Nodes.json
    &{object}=    Evaluate     json.loads('''${json}''')     json
	${count}=       set variable     0
    FOR   ${key}   IN  @{object.keys()}
        Run Keyword And Continue on Failure    Verify report creation for'Calendar Interval', 'All Selected' and 'Nodes'	${object}[${key}]
...
*** keywords ***
Verify report creation for'Calendar Interval', 'All Selected' and 'Nodes'
    [Arguments]      ${data}
