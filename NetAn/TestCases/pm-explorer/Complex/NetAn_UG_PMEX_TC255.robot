...
Documentation     Verify Report Creation for Preceding period All Selected and Subnetwork
...
Verify Report creation in PMEX  
    [Tags]     PMEX          
    ${json}=    OperatingSystem.get file    ./ENIQ_TC_Automation/NetAn/Resources/Data/pm-explorer/PMEXWebUI_Preceding_Period_All_Selected_SubNetwork.json
    &{object}=    Evaluate     json.loads('''${json}''')     json
    FOR    ${key}   IN    @{object.keys()}
        Run Keyword And Continue On Failure    Verify Report Creation for Preceding period All Selected and Subnetwork    ${Object}[${key}] 
    END  


*** keywords ***

Verify Report Creation for Preceding period All Selected and Subnetwork 
    [Arguments]     ${data}
