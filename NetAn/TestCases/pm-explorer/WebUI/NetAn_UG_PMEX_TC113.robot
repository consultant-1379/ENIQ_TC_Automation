*** Settings ***
Documentation     Verify The Access Button Will Be Active If Public Collection Is Not Used
...
Verify The Access Button Will Be Active If Public Collection Is Not Used
