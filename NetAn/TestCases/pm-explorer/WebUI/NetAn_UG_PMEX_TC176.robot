...
Documentation     Create Parallel Coordinate graph into the Report
...
Report creation with Parallel Coordinate graph
	...
	Click on Save report to Library button
	select the created report    ${report_name}
	Verify the graph list is displayed for report    ParallelCoordinatePlot
