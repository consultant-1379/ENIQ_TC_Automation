*** Settings ***
Documentation      Validate Report Generation For Custom KPI For PDF+Flex Counter
...
Validate Report Generation For Custom KPI For PDF+Flex Counter
    [Tags]    Custom_KPI	  PMEX_CDB      NetAn_UG_PMEX_TC79
