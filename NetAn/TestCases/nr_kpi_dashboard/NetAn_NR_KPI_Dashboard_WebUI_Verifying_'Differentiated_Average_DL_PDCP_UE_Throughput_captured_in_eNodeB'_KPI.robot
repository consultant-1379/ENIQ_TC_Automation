...
Verifying "Differentiated Average DL PDCP UE Throughput captured in eNodeB" KPI
	...
	${KPI}=    add the KPI to selected KPIs    Differentiated Average DL PDCP UE Throughput captured in eNodeB
