...
Verifying "EN-DC Intra-sgNodeB PSCell Change Success Rate Captured in gNodeB" KPI
	...
	${KPI}=    add the KPI to selected KPIs    EN-DC Intra-sgNodeB PSCell Change Success Rate Captured in gNodeB
