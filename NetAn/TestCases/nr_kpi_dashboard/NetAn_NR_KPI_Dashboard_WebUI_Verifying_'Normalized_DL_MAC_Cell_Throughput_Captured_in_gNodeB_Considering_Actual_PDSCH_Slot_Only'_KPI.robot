...
Verifying "Normalized DL MAC Cell Throughput Captured in gNodeB Considering Actual PDSCH Slot Only" KPI
	...
	${KPI}=    add the KPI to selected KPIs    Normalized DL MAC Cell Throughput Captured in gNodeB Considering Actual PDSCH Slot Only
