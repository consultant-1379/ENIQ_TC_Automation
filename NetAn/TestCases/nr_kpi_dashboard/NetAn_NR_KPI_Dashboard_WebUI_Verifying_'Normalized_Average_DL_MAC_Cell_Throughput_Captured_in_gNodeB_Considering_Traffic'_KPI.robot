...
Verifying "Normalized Average DL MAC Cell Throughput Captured in gNodeB Considering Traffic" KPI
	...
	${KPI}=    add the KPI to selected KPIs    Normalized Average DL MAC Cell Throughput Captured in gNodeB Considering Traffic
