...
Verifying "Random Access Success Rate captured in eNodeB" KPI
	...
	click on the scroll down button    1    1
	${KPI}=    add the KPI to selected KPIs    Random Access Success Rate captured in eNodeB
