...
Verifying "Average DL MAC DRB Latency per QoS Covering DRX in-Sync" KPI
	...
	${KPI}=    add the KPI to selected KPIs    Average DL MAC DRB Latency per QoS Covering DRX in-Sync
