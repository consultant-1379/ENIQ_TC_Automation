...
Verifying "Differentiated Initial E-RAB Establishment Success Rate, no MO signaling captured in eNodeB" KPI
	...
	${KPI}=    add the KPI to selected KPIs    Differentiated Initial E-RAB Establishment Success Rate, no MO signaling captured in eNodeB
