...
Verifying "EN-DC Intra-frequency Handover Success Rate Captured in Source sgNodeB" KPI
	...
	${KPI}=    add the KPI to selected KPIs    EN-DC Intra-frequency Handover Success Rate Captured in Source sgNodeB
