...
Verifying "SCG Radio Resource Retainability Captured in gNodeB" KPI
	...
	click on the scroll up button    6    10
	${KPI}=    add the KPI to selected KPIs    SCG Radio Resource Retainability Captured in gNodeB
