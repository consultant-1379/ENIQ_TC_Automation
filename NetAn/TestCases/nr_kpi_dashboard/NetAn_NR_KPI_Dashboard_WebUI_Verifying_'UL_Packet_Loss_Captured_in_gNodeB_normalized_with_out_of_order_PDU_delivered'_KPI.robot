...
Verifying "UL Packet Loss Captured in gNodeB normalized with out of order PDU delivered" KPI
	...
	${KPI}=    add the KPI to selected KPIs    UL Packet Loss Captured in gNodeB normalized with out of order PDU delivered
