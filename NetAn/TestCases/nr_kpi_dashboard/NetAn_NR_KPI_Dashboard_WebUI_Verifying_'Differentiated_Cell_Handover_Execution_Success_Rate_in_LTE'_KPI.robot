...
Verifying "Differentiated Cell Handover Execution Success Rate in LTE" KPI
	...
	${KPI}=    add the KPI to selected KPIs    Differentiated Cell Handover Execution Success Rate in LTE
