...
Verifying "Differentiated Initial E-RAB Establishment Success Rate Captured in eNodeB" KPI
	...
	${KPI}=    add the KPI to selected KPIs    Differentiated Initial E-RAB Establishment Success Rate captured in eNodeB
