...
Verifying "Differentiated Average CA DL PDCP UE Throughput Captured in eNodeB" KPI
	...
	${KPI}=    add the KPI to selected KPIs    Differentiated Average CA DL PDCP UE Throughput captured in eNodeB
