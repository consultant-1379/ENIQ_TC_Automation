...
Verifying "DL MAC DRB Throughput per QoS Captured in gNodeB" KPI
	...
	click on the scroll down button    3    4
	${KPI}=    add the KPI to selected KPIs    DL MAC DRB Throughput per QoS Captured in gNodeB
