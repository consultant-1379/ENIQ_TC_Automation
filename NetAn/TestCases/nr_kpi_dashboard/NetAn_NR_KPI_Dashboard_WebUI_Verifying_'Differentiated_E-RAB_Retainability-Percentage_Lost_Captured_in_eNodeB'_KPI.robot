...
Verifying "Differentiated E-RAB Retainability - Percentage Lost Captured in eNodeB" KPI
	...
	click on the scroll up button    6    5
	${KPI}=    add the KPI to selected KPIs    Differentiated E-RAB Retainability - Percentage Lost captured in eNodeB
