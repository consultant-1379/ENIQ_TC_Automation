...
Verifying "NR-to-LTE Inter-RAT Handover success rate captured in source gNodeB" KPI
	...
	${KPI}=    add the KPI to selected KPIs    NR-to-LTE Inter-RAT Handover success rate captured in source gNodeB
