...
Verifying "Differentiated Average UL UE LCG Throughput Captured in eNodeB" KPI
	...
	Click on the scroll down button    3   14
	${KPI}=    add the KPI to selected KPIs    Differentiated Average UL UE LCG Throughput Captured in eNodeB
