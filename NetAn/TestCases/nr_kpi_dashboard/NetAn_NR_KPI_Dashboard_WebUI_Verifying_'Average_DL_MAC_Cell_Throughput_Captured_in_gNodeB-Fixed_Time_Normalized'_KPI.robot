...
Verifying "Average DL MAC Cell Throughput Captured in gNodeB- Fixed Time Normalized" KPI
	...
	${KPI}=    add the KPI to selected KPIs    Average DL MAC Cell Throughput Captured in gNodeB- Fixed Time Normalized
