...
Verifying "Average UL MAC Cell Throughput - Fixed Time Normalized" KPI
	...
	Click on the scroll down button    3   6
	${KPI}=    add the KPI to selected KPIs    Average UL MAC Cell Throughput - Fixed Time Normalized
