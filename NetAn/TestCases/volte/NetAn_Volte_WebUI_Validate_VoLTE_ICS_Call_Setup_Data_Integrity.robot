...
Test Case: Volte Validate 'ICS Call setup' data integrity
	open volte analysis
	...
	${sql_query}=    get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/volte/VoLTE_dataIntegrity.json     MTAS
