...
Test Case: Volte Validate 'VoLTE Service Attach and Registration' data integrity
	open volte analysis
	...
	click on tab    VoLTE Service Attach and Registration
	...
	${sql_query}=    get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/volte/VoLTE_dataIntegrity.json     GGSN
