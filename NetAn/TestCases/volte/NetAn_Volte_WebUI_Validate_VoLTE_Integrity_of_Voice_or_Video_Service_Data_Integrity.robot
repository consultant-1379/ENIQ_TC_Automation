...
Test Case: Volte Validate 'Integrity of Voice/Video Service' data integrity
	open volte analysis
	...
	click on tab    Integrity of Voice/Video Service
	...
	${nodeName}    ${measureName}    ${cellFDN}    ${dateTime}    ${measureValue}=    recording nodeName, measureName, cellFDN, dateTime and measureValue for ERBS
	...
	${sqlQuery}=    Replace The Values In The Query For ERBS    ${sql_query}    ${nodeName}    ${measureName}    ${cellFDN}    ${dateTime}
