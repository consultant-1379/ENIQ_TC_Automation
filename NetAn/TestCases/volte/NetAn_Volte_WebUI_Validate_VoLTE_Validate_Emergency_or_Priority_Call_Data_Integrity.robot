...
Test Case: Volte Validate 'Emergency or Priority Call' data integrity
	open volte analysis
	...
	click on tab    Emergency or Priority Call
	...
	${sql_query}=    get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/volte/VoLTE_dataIntegrity.json     SBG
