*** Settings ***
Documentation     Verify the Cell Performance for Failure Rate of DL Throughput >= 1500.00 Mbps in NR App coverage
...
*** Test Cases ***
Validate Cell Performance for Failure Rate of DL Throughput >= 1500.00 Mbps
	[Tags]    NR_AC_KGB    NetAn_UG_NRAC_06       NR_AC_CDB
	...
	${CellFailureRate}=	 	place cursor on "Cell Failure Rate over Time" chart and record its tooltip values
	${sql_query}=      get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/nr-app-coverage/nrappCoverageDataIntegrity.json    TC03
