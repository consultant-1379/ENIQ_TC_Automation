*** Settings ***
Documentation     Verify the CellFailure Rate of UL Throughput >= 150.00 Mbps in NR App coverage
...
Validate for CellFailure Rate of UL Throughput >= 150.00 Mbps
	[Tags]    NR_AC_KGB    NetAn_UG_NRAC_07      NR_AC_CDB
	...
	${sql_query}=      get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/nr-app-coverage/nrappCoverageDataIntegrity.json    TC04
