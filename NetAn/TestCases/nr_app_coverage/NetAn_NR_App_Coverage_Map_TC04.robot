*** Settings ***
Documentation     Verify the DataIntegrity for CellFailure Rate of Downlink DL Throughput >=0.10 Mbps in NR App coverage
...
Verify DataIntegrity for CellFailure Rate of Downlink DL Throughput >=0.10 Mbps
	[Tags]    NR_AC_KGB    NetAn_UG_NRAC_04         NR_AC_CDB
	...
	${sql_query}=      get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/nr-app-coverage/nrappCoverageDataIntegrity.json    TC01
