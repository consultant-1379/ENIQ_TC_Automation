...
Verify DataIntegrity
    ...
    Run Keyword And Continue on Failure       Verify DataIntegrity for Uplink Throughput >=2.00 Mbps    ${object}[TC09]
    
    
*** Keywords ***  

Verify DataIntegrity for Uplink Throughput >=2.00 Mbps 
	[Arguments]      ${data}
	...
	select the performance target for UL	UL Throughput >=2.00 Mbps
