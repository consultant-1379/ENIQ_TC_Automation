...
Verify 'Cell Site Location' Page for Uplink Performance
	...
	select throughput type    Uplink
	set performance target    UL Throughput >=1.00 Mbps
	...
	verify that the graph title is visible    Failure Rate per Cell (UL Throughput >=1.00 Mbps)
