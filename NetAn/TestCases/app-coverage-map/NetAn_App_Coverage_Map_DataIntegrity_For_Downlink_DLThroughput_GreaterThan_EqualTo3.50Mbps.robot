...
Verify DataIntegrity
    ...
    Run Keyword And Continue on Failure       Verify DataIntegrity for Downlink DL Throughput >=3.50 Mbps    ${object}[TC02]
    
    
*** Keywords ***  

Verify DataIntegrity for Downlink DL Throughput >=3.50 Mbps
	[Arguments]      ${data}
