...
Verify DataIntegrity
    ...
    Run Keyword And Continue on Failure       Verify DataIntegrity for Uplink Throughput >=10.00 Mbps    ${object}[TC10]
    
    
*** Keywords ***  

Verify DataIntegrity for Uplink Throughput >=10.00 Mbps 
	[Arguments]      ${data}
	...
	select the performance target for UL	UL Throughput >=10.00 Mbps
