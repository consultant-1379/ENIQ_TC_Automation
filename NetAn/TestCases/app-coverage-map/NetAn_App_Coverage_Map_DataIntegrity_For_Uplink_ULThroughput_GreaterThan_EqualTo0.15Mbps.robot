...
Verify DataIntegrity
    ...
    Run Keyword And Continue on Failure       Verify DataIntegrity for Uplink Throughput >=0.15 Mbps    ${object}[TC06]
    
    
*** Keywords ***  

Verify DataIntegrity for Uplink Throughput >=0.15 Mbps 
	[Arguments]      ${data}
	...
	select the performance target for UL	UL Throughput >=0.15 Mbps
