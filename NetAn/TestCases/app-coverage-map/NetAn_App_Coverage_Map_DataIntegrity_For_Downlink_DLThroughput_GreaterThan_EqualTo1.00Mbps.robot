...
Verify DataIntegrity
    ...
    Run Keyword And Continue on Failure       Verify DataIntegrity for Downlink DL Throughput >=1.00 Mbps    ${object}[TC01]
    
*** Keywords ***  

Verify DataIntegrity for Downlink DL Throughput >=1.00 Mbps
	[Arguments]      ${data}
