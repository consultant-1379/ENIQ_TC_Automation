...
Verify DataIntegrity
    ...
    Run Keyword And Continue on Failure       Verify DataIntegrity for Downlink DL Throughput >=20.00 Mbps    ${object}[TC05]
    
    
*** Keywords ***  

Verify DataIntegrity for Downlink DL Throughput >=20.00 Mbps
	[Arguments]      ${data}
