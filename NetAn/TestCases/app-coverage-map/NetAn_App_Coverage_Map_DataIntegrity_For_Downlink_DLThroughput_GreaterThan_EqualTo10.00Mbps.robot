...
Verify DataIntegrity
    ...
    Run Keyword And Continue on Failure       Verify DataIntegrity for Downlink DL Throughput >=10.00 Mbps    ${object}[TC04]
    
    
*** Keywords ***  

Verify DataIntegrity for Downlink DL Throughput >=10.00 Mbps
	[Arguments]      ${data}
