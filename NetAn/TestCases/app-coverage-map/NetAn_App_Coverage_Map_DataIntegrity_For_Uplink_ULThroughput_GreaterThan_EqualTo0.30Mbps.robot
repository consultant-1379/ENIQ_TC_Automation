...
Verify DataIntegrity
    ...
    Run Keyword And Continue on Failure       Verify DataIntegrity for Uplink Throughput >=0.30 Mbps    ${object}[TC07]
    
    
*** Keywords ***  

Verify DataIntegrity for Uplink Throughput >=0.30 Mbps 
	[Arguments]      ${data}
	...
	select the performance target for UL	UL Throughput >=0.30 Mbps
