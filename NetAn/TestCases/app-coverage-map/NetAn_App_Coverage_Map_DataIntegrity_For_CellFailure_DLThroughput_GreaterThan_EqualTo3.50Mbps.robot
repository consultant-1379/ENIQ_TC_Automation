...
Verify DataIntegrity for CellFailure Rate of Downlink DL Throughput >=3.50 Mbps
	...
	select the performance target		DL Throughput >=3.50 Mbps
	...
	${sql_query}=      get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/app-coverage-map/appCoverageDataIntegrity.json    TC12
