*** Settings ***
Documentation     Verify the HSS-FE: Platform and Capacity page
...
Verify the HSS-FE: Platform and Capacity page
    [Tags]      TC07     IMS_CDB     IMS_KGB
    ...
    verify buttons for Capacity         HSS-FE
