*** Settings ***
Documentation     Verify the CSCF: Filtered Data For Platform and Capacity Page
...
*** Test Cases ***
Verify the Functionality of CSCF: Filtered Data For Platform and Capacity Page
    [Tags]      TC01     IMS_CDB     IMS_KGB
    ...
    ${sql_query}=      get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/ims-capacity/dataIntegrity.json     cscf_CPU_Load
