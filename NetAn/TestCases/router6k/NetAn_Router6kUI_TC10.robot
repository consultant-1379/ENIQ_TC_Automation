...
Documentation     Router6k Verify the data table in Interface Level KPIs - Filtered Data page
...
Verifying the data table in Interface Level KPIs Filtered Data page
