*** Settings ***
Documentation     Validate Alarm Generation With Multiple Measure Types
...
Validate Alarm Generation With Multiple Measure Types
	[Tags]      PMA_CDB     NetAn_UG_PMA_TC67    MR-EQEV-110751
    ...
    Select Measure type as     KPI,COUNTER
    Select measures    Average Overall DL Latency,pmBwpUeConfSumDistr.DC_E_NR_NRCELLDU_V_RAW
