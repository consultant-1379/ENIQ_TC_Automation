...
Documentation     MR-EQEV-110783 Validate Alarm creation for Flex counter as All
...
Validate Alarm creation for Flex counter as All
    [Tags]        PMA_CDB     EQEV-110783    NetAn_UG_PMA_TC230
    ...
    Select Flex value from dropdown     All	
