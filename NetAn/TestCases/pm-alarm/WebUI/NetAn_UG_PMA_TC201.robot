...
Documentation     Verify That The Close Button Is Working Properly In Alarm Deletion Dialog Box
...
Verify That The Close Button Is Working Properly In Alarm Deletion Dialog Box
	[Tags]      PMA_CDB        NetAn_UG_PMA_TC201
