*** Settings ***
Documentation     Verify multiple selection for Permanent Delete of Collection & Alarm
...
Verify multiple selection for Permanent Delete of Collection & Alarm
	...
	Select the collection		${collection1},${collection2}
	Click on Permanently Delete button for collection
	Verify multiple collections are deleted from deleted items			${collection1},${collection2}
	Click on Node Collection manager button
	Verify multiple collections are deleted from Node Collection Manager		${collection1},${collection2}
	...
	Click on Deleted Items
	Select the alarm		${alarm_name1},${alarm_name2}
	Click on Permanently Delete button for alarm
	Verify multiple alarms are removed from deleted items		${alarm_name1},${alarm_name2}
	Click on Alarm rules manager button
	Verify multiple alarms are removed from Alarm Rules		${alarm_name1},${alarm_name2}
