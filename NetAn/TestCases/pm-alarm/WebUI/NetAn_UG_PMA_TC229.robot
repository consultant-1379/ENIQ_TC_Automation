...
Documentation    MR-EQEV-110783 Validate Alarm creation for PDF+Flex counter as Custom
...
*** Test Cases ***
Validate Alarm creation for PDF+Flex counter as custom
    [Tags]        EQEV-110783    NetAn_UG_PMA_TC229      PMA_CDB
