...
*** Test Cases ***
Verify alarm generation in PMA for subnetwork
    ${json}=    OperatingSystem.get file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/pm-alarm/PMA_WebUI_Alarm_verification_subnetwork.json
...
Verify alarm generation for pcd_cd alarm
    ...
    Select Subnetwork as      ${data}[Subnetwork]
