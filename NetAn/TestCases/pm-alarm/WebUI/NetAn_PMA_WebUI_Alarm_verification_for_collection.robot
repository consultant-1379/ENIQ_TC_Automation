...
*** Test Cases ***
Verify alarm generation in PMA for collection
    ${json}=    OperatingSystem.get file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/pm-alarm/PMA_WebUI_Alarm_verification_collection.json
...
Verify alarm generation for pcd_cd alarm
    ...
    Select Collection name as      ${data}[Collection_name]
