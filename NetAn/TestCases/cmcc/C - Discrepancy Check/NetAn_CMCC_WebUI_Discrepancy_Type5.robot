...
Documentation     Verifying That The DB And UI Discrepancy Values Match For Caps And Small MO Class 
...
Verifying That The DB And UI Discrepancy Values Match For Caps And Small MO Class
	[Tags]    CMCC_CDB
	open cmcc analysis
	...
	${sql_query}=    get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/cmcc/cmcc.json     Type5
