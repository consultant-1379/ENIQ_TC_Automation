...
Documentation     Verifying That The DB And UI Discrepancy Values Match For Where Clause   
...
Verifying That The DB And UI Discrepancy Values Match For Where Clause
	[Tags]    CMCC_CDB
	open cmcc analysis
	...
	${sql_query}=    get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/cmcc/cmcc.json     Type3
