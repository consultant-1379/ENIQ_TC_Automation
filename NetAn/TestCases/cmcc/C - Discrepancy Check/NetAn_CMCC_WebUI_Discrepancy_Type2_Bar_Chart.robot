...
Documentation     Verify Discrepancies Worst Node Bar Chart has Data for Vector Attribute  
...
Verify Discrepancies Worst Node Bar Chart has Data for Vector Attribute
	[Tags]    CMCC_CDB
	open cmcc analysis
