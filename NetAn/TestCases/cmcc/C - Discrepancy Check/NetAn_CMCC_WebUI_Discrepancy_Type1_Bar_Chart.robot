...
Documentation     Verify Discrepancies Worst Nodde Bar Chart has Data for Normal Attribute    
...
Verify Discrepancies Worst Node Bar Chart has Data for Normal Attribute
	[Tags]    CMCC_CDB
	open cmcc analysis
