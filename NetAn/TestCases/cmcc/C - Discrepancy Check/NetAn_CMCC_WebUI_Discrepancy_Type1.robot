...
Documentation     Verifying That The DB And UI Discrepancy Values Match For Normal Attribute
...
Verifying That The DB And UI Discrepancy Values Match For Normal Attribute
	[Tags]    CMCC_CDB
	open cmcc analysis
	click on Rule Manager button
	verify the page title    CM Rule Manager
	Filter MO Class    AnrFunction    
	...
	${sql_query}=    get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/cmcc/cmcc.json     Type1
