...
Documentation     Verify CMCC Edit Button for Rule1 leaving Mandatory Fields as empty
...
Verify CMCC Edit Button for Rule1 leaving Mandatory Fields as empty
	[Tags]    CMCC_CDB
	open cmcc analysis
	...
	Edit Text in Existing Value    Value    ${EMPTY}	         
