...
Verify Data Integrity For PRB Noise Rise Average
	...
	${sql_query}=      get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/uplink-interference/Uplink-Interference-dataIntegrity-SQLs.json    prbNoiseRiseAverage
