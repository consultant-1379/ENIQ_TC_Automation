...
Deleting Measures from Overview Table View in 'MRR Overview Report' page
	...
	verify that the measure is not present in Overview Table View    FER DL Average (GSM)
