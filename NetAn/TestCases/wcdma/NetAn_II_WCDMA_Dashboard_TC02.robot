*** Settings ***
Documentation     Verify Data Integrity for 'Packetint_U_Trafficvolume' KPI
...
Verify Data Integrity for 'Packetint_U_Trafficvolume' KPI
    [Tags]       WCDMA_CDB
	...
	select a Utilization KPI    Total traffic volume (Packetint_U_Trafficvolume)
	...
	${sql_query}=    get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/ran-performance-overview/RPO_dataIntegrity.json     Packetint_U_Trafficvolume_Today
	...
	${sql_query1}=    get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/ran-performance-overview/RPO_dataIntegrity.json     Packetint_U_Trafficvolume_Pastweek
