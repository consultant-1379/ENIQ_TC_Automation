*** Settings ***
Documentation     Verify Data Integrity for 'Speech_M_CSFB_AR' KPI
...
Verify Data Integrity for 'Speech_M_CSFB_AR' KPI
    [Tags]       WCDMA_CDB
	...
	select a Mobility and Accessibility KPI    Share of speech calls originating from CS fall back from LTE (Speech_M_CSFB_AR)
	...
	${sql_query}=    get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/ran-performance-overview/RPO_dataIntegrity.json     Speech_M_CSFB_AR_Today
	...
	${sql_query1}=    get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/ran-performance-overview/RPO_dataIntegrity.json     Speech_M_CSFB_AR_Pastweek
