*** Settings ***
Documentation     Verify Data Integrity for 'PacketintHs_U_MHT' KPI
...
Verify Data Integrity for 'PacketintHs_U_MHT' KPI
    [Tags]       WCDMA_CDB
	...
	select a Utilization KPI    Average session length for data connections (PacketintHs_U_MHT)
	...
	${sql_query}=    get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/ran-performance-overview/RPO_dataIntegrity.json     PacketintHs_U_MHT_Today
	...
	${sql_query1}=    get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/ran-performance-overview/RPO_dataIntegrity.json     PacketintHs_U_MHT_PastWeek
