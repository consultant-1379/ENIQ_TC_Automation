*** Settings ***
Documentation     Verify Data Integrity for 'PacketintHs_IDI_Tp' KPI
...
Verify Data Integrity for 'PacketintHs_R' KPI
    [Tags]       WCDMA_CDB
	...
	select a QoS KPI    HS connection drop rate (PacketintHs_R)
	...
	${sql_query}=    get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/ran-performance-overview/RPO_dataIntegrity.json     PacketintHs_R_Today
	...
	${sql_query1}=    get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/ran-performance-overview/RPO_dataIntegrity.json     PacketintHs_R_PastWeek
