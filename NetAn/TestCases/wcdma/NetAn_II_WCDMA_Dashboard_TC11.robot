*** Settings ***
Documentation     Verify Data Integrity for 'Speech_M_IRATHO' KPI
...
Verify Data Integrity for 'Speech_M_IRATHO' KPI
    [Tags]       WCDMA_CDB
	...
	select a Mobility and Accessibility KPI    Handover to GSM success rate for speech (Speech_M_IRATHO)
	...
	${sql_query}=    get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/ran-performance-overview/RPO_dataIntegrity.json     Speech_M_IRATHO_Today
	...
	${sql_query1}=    get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/ran-performance-overview/RPO_dataIntegrity.json     Speech_M_IRATHO_PastWeek
