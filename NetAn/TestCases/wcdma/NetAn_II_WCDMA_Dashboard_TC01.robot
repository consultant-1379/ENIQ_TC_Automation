*** Settings ***
Documentation     Verify Data Integrity for 'PacketInt_A' KPI
...
Verify Data Integrity for 'PacketInt_A' KPI
    [Tags]       WCDMA_CDB
	...
	Verify the colour of the displayed value        diffIn2RopsOverKPI3       3
	Verify the colour of the displayed value        diffIn2RopsOverKPI15       16
	...
	select a Mobility and Accessibility KPI    Data accessibility (Packetint_A)
	...
	${sql_query}=    get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/ran-performance-overview/RPO_dataIntegrity.json     PacketInt_A_Today
	...
	${sql_query1}=    get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/ran-performance-overview/RPO_dataIntegrity.json     PacketInt_A_PastWeek
