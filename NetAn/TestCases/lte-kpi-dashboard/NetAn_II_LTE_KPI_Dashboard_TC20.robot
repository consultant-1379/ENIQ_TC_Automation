...
Documentation     Verifying The Latest the Upto 7days Chart For 'UTRAN SRVCC Success Rate' KPI
...
Verifying The Latest the Upto 7days Chart For 'UTRAN SRVCC Success Rate' KPI
	[Tags]     LTE_KPI_CDB
