*** Settings ***
Documentation     Verifying The Worst Performing Chart For 'Mean UL PDCP UE Throughput' KPI
...
Verifying The Worst Performing Chart For 'Mean UL PDCP UE Throughput' KPI
	[Tags]     LTE_KPI_CDB
