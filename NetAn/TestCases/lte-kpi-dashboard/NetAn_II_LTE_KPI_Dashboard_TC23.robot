...
Verifying The Difference Value For 'E-RAB Retainability - Percentage Lost for Emergency Calls' KPI
	...
	${KPI}=    add the KPI to selected KPIs    E-RAB Retainability - Percentage Lost for Emergency Calls
	...
	${sql_query}=    get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/lte-kpi-dashboard/LTE_KPI_Dashboard_DataIntegrity.json     TC_22
	${DB_Value}=    Query Sybase database    ${sqlQuery}
	${sql_query1}=    get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/lte-kpi-dashboard/LTE_KPI_Dashboard_DataIntegrity.json     TC_23
