...
Verifying The Difference Value For 'Initial E-RAB Establishment Success Rate for Emergency Calls' KPI
	...
	${sql_query1}=    get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/lte-kpi-dashboard/LTE_KPI_Dashboard_DataIntegrity.json     TC_35
