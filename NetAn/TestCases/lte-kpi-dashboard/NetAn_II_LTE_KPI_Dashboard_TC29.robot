...
Verifying The Difference Value For 'GTP-U Downlink Packet Out of Order Rate' KPI
	...
	${KPI}=    add the KPI to selected KPIs    GTP-U Downlink Packet Out of Order Rate
	...
	${sql_query}=    get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/lte-kpi-dashboard/LTE_KPI_Dashboard_DataIntegrity.json     TC_28
	${DB_Value}=    Query Sybase database    ${sqlQuery}
	${sql_query1}=    get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/lte-kpi-dashboard/LTE_KPI_Dashboard_DataIntegrity.json     TC_29
