...
Verifying The Difference Value For 'UTRAN SRVCC Success Rate' KPI
	...
	${sql_query}=    get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/lte-kpi-dashboard/LTE_KPI_Dashboard_DataIntegrity.json     TC_16
	${DB_Value}=    Query Sybase database    ${sqlQuery}
	${sql_query1}=    get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/lte-kpi-dashboard/LTE_KPI_Dashboard_DataIntegrity.json     TC_17
