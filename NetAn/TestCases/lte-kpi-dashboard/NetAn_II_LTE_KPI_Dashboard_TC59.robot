...
Verify The Data Is Shown For 'Average DL Packet Error Loss Rate' KPI In KPI View - Node Page
	[Tags]     LTE_KPI_CDB
	...
	select a KPI on KPI view - Node page    Average DL Packet Error Loss Rate
