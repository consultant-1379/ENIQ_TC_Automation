...
Verify Hardware And Software Overview Functionality-Chart 'Data volume per software'
	...
	click on button value    Software Throughput >>
	verify the page title    Software Overview - Throughput (7 Days)
