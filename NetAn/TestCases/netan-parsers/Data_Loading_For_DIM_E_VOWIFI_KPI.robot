...
Data loading for DIM_E_VOWIFI_KPI table
	...
	sleep    30
	${db_result}=    Query Sybase database    select * from DIM_E_VOWIFI_KPI 
    Verify that the table has data    ${db_result}    DIM_E_VOWIFI_KPI
