...
${counter_mapping_url}      spotfire/wp/analysis?file=&waid=kEav5e3HWEqhR7VmVYeT3-290707061eQKCh&wavid=0
${Library_path}             sfx_title_552 sfx_one-line_517
...
open counter mapping table in pm-data
	...
	Sleep    5
    Go To    ${base_url}${counter_mapping_url}
    click on the button    Spotfire library
    Wait Until Element Is Visible     xpath: (//div[@class="${Library_path}" and contains(text(),'Ericsson Library')])    30
    Double Click element     xpath: (//div[@class="${Library_path}" and contains(text(),'Ericsson Library')])
    Wait Until Element Is Visible     xpath: (//div[@class="${Library_path}" and contains(text(),'General')])    30
    Double Click element     xpath: (//div[@class="${Library_path}" and contains(text(),'General')])
    Wait Until Element Is Visible     xpath: (//div[@class="${Library_path}" and contains(text(),'PM Data')])    30
    Double Click element     xpath: (//div[@class="${Library_path}" and contains(text(),'PM Data')])
    Wait Until Element Is Visible     xpath: (//div[@class="${Library_path}" and contains(text(),'PM-Data')])    30
    Double Click element     xpath: (//div[@class="${Library_path}" and contains(text(),'PM-Data')])
    Wait Until Element Is Visible     xpath: (//div[@class="${Library_path}" and contains(text(),'Analysis')])    30
    Double Click element     xpath: (//div[@class="${Library_path}" and contains(text(),'Analysis')])
    Wait Until Element Is Visible     xpath: (//div[@class="${Library_path}" and contains(text(),'Counter Mapping')])    30
    Double Click element     xpath: (//div[@class="${Library_path}" and contains(text(),'Counter Mapping')])
    click on the button    OK
    click on the button    Start from visualizations
    Wait Until Element Is Visible     xpath: ((//div[@class="sfx_section_322"])//div)[1]    30
    Click element     xpath: ((//div[@class="sfx_section_322"])//div)[1]
...
filter the counter values with
    ...
    wait until page contains element    xpath: (//div[@class="sfx_item-text_986 sf-element-text-box" and contains(text(),'NODETYPE')])     30
    ${status}=    run keyword and return status    element should be visible    xpath: (//div[@class="sfx_item-text_986 sf-element-text-box" and contains(text(),'NODETYPE')])
    Run keyword if    ${status}==False    Click on the scroll down button    1    10 
    Click element    xpath: (//div[@class="sfx_item-text_986 sf-element-text-box" and contains(text(),'NODETYPE')])
    wait until element is visible    xpath: ((((//div[@class='sfx_item-content_979 sfx_selected-item_964 sfpc-selected sfx_body-item-content_969' and div[1]='NODETYPE'])//div)[7])//div[@title='Show filter'])    30
    click element    xpath: ((((//div[@class='sfx_item-content_979 sfx_selected-item_964 sfpc-selected sfx_body-item-content_969' and div[1]='NODETYPE'])//div)[7])//div[@title='Show filter'])
	...
	#Click element    xpath://div[@class='sfx_item-content_979 sfx_selected-item_964 sfpc-selected sfx_body-item-content_969']//div[@class='sfx_select-icon_973']
    click on the button    Data in analysis
