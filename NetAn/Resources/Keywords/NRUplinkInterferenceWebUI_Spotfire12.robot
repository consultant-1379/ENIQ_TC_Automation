...
Click on Channel Bandwidth checkbox
	...
	Wait Until Element Is Visible     xpath:(//div[@class="flex-item flex-container-horizontal flex-inline-container flex-align-center"])[101]    30
	Click Element       xpath:(//div[@class="flex-item flex-container-horizontal flex-inline-container flex-align-center"])[101]
	wait for page to load
	capture page screenshot
...
Verify message asking cell selection on Health Check page
	sleep    5
    element should contain    xpath: //span[@id='043f09d19ba94d929119646fe97154a9']    Please mark the Node(s)
	wait for page to load
	capture page screenshot
