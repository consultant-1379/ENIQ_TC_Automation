...
wait for page to load
    ...
    Wait Until Element Is Not Visible     class:sfx_progress-bar-container_1369       timeout=3000
    Sleep   3s
    Wait Until Element Is Not Visible     class:sfx_progress-bar-container_1369       timeout=3000
    Sleep   3s
...
read the marked value
	${markedValue}=    Selenium2Library.get text 	xpath://div[@class="sfx_label_379"][2]
	[Return]    ${markedValue}
	wait for page to load
	capture page screenshot
...
verify that the marked value is not equal to
	...
	${newMarked}=    Selenium2Library.get text 	xpath://div[@class="sfx_label_379"][2]
	should not be equal    ${newMarked}    ${markedValue}
	wait for page to load
	capture page screenshot
	
Go to home page if not already at home
	${pageTitle}=    Selenium2Library.Get text  xpath: //*[@class="sfx_page-title_375"]
	IF 		"${pageTitle}" != "Home"	
