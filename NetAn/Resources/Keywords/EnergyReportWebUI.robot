...
select an Energy Saving Feature
	Wait Until Element Is Visible     xpath:((//div[@class="ListItems"])[2]//div[@class="sf-element-list-box-item"])[3]    30
	Click Element       xpath:((//div[@class="ListItems"])[2]//div[@class="sf-element-list-box-item"])[3]
	wait for page to load
	capture page screenshot
...
go to energy report home page
	Wait Until Element Is Visible     xpath://*[@class="sfx_page-title_219"]    300
	${text}=    Selenium2Library.Get text  xpath: //*[@class="sfx_page-title_219"]
    Log    ${text}
    IF    "${text}"!="Home"
