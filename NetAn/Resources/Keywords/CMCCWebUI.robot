...
go to home page if not at home
	wait until element is visible    xpath: //*[@class="sfx_page-title_219"]    30
...
select bar charts in discrepancis page
	...
	selenium2library.drag and drop by offset    xpath:(//div[@class="sf-element-canvas-image sfc-transition-background"])    100    80	
	wait for page to load
	capture page screenshot
