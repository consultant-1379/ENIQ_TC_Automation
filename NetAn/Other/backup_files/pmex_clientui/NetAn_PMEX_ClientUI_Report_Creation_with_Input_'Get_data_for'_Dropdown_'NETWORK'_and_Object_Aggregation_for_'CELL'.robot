*** Settings ***
Force Tags  suite
Documentation     Verify Report Creation with Input 'Get data for' Dropdown 'NETWORK' and Object Aggregation for 'CELL' in PMEX client
...
*** Test Cases ***
Verify Report Creation with Input 'Get data for' Dropdown 'NETWORK' and Object Aggregation for 'CELL' in PMEX client
	...
	Add Test Case    TC07   Verify report creation      ${object}[TC07]
