*** Settings ***
Force Tags  suite
Documentation     Delete a Report as Administrator
...
*** Test Cases ***
Delete a Report as Administrator
    ...
    FOR   ${key}   IN  @{object.keys()}
	    IF     '${count}'=='0'
                Run keyword       Create and Delete a Report as Administrator       ${object}[${key}]
                ${count}=       set variable     1
        ELSE				
                Add Test Case    ${key}   Create and Delete a Report as Administrator       ${object}[${key}]
		END
        
    END
    
*** Keywords ***   
Create and Delete a Report as Administrator
    [Arguments]      ${data}
