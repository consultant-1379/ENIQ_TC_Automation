*** Settings ***
Force Tags  suite
Documentation     Verify Report creation with input 'Get data for' Dropdown Node(s) and object aggregation for 'NODE' in PMEX client
...
*** Test Cases ***
Verify Report creation with input 'Get data for' Dropdown Node(s) and object aggregation for 'NODE' in PMEX client
	...
	Verify report creation      ${object}[TC05]
