*** Settings ***
Force Tags  suite
Documentation     Verify Report Creation with Get Data for-Nodes, Object Aggregation-All selected, Node Type-Core and Calendar Interval in PMEX client
...
*** Test Cases ***
Verify Report Creation with Get Data for-Nodes, Object Aggregation-All selected, Node Type-Core and Calendar Interval in PMEX client
	...
	Verify report creation      ${object}[TC04]
