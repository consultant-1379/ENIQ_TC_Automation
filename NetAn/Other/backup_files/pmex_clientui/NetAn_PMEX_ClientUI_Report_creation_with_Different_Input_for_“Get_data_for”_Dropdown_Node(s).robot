*** Settings ***
Force Tags  suite
Documentation     Verify Report Creation with Input 'Get data for' Dropdown 'Nodes' in PMEX client
...
*** Test Cases ***
Verify Report Creation with Input 'Get data for' Dropdown 'Nodes' in PMEX client
	...
	Verify report creation      ${object}[TC10]
