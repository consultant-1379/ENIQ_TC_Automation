*** Settings ***
Force Tags  suite
Documentation     Verify Report Creation with Input 'Get data for' Dropdown 'SUBNETWORK' in PMEX client
...
*** Test Cases ***
Verify Report Creation with Input 'Get data for' Dropdown 'SUBNETWORK' in PMEX client
	...
	Add Test Case    TC08   Verify report creation      ${object}[TC08]
...
Verify report creation
	...
	${test_script}=    Get iron_python script by passing project location for pmex usecase2    ${scripts}\\pmexSubNetworkReportCreationScript.py     ${data}     ${loc}		MOID
	Log 	${test_script}
