...
Validate the 'Measure Type': "MultiTable KPI+counter " combination list in Alarm Rule Manager page
    ...
    Add Test Case    TC07   Validate the Measure Type combination list in Alarm Rule Manager page      ${object}[TC07]
...
Validate the Measure Type combination list in Alarm Rule Manager page
    ...
    ${test_script}=    Get iron_python script for PMA Alarm verification for usecase    ${scripts}\\PMAMultiTablekpiCounterRI.py     ${data}		${loc}																																	   
