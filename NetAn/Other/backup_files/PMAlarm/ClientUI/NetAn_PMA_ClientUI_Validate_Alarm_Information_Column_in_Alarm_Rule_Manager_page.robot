...
Validate the 'Alarm Information'Column in Alarm Rule Manager page
    ...
    Add Test Case    TC02   Validate the 'Alarm Information'Column   ${object}[TC02]
    
*** Keywords ***  
Validate the 'Alarm Information'Column
    [Arguments]      ${data}
    Launch Tibco spotfire PMA Application
    ${loc}=		Replace String 		${file_loc}	 \\		\\\\ 
    ${test_script}=    Get iron_python script for PMA Alarm verification for usecase    ${scripts}\\AlarmInfoColumn.py     ${data}		${loc}																																	   
