*** Settings ***
Force Tags  suite
Documentation     PMAUseCase for collection
...
Verify Alarm generation and Data Integrity
    [Tags]  moid
    Log		${EXEC_DIR}
    ${json}=    OperatingSystem.get file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/pm-alarm/PMAClientUsecase_Collection.json
