...
Verify All Counters From Latest TP Are Present In Counter Mapping Table
    ...
    ${selectedRows}=    filter the counter values with    SBG
    ${sql_query}=    get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/pm-data/SBG_SQL.json    SBG
