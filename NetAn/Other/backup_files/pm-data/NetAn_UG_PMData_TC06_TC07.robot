...
Verify Data Integrity Of The New Measure In PMA
    ...
    add test case    PCC_KPI_PMA     Verify DataIntegrity Of The Measure In PMA       ${object}[PCC_KPI_PMA]
...
Verify DataIntegrity Of The Measure In PMA
    ...
    #Verify data integrity of the measures in PMA      ${data}[Measure]     ${data}[SQL1]        ${data}[SQL2]        ${data}[SQL3]        ${data}[SQL4]
