...
Verify All Counters From Latest TP Are Present In Counter Mapping Table
    ...
    ${selectedRows}=    filter the counter values with    CSCF
    ${sql_query}=    get sql query from json file    ${EXEC_DIR}/ENIQ_TC_Automation/NetAn/Resources/Data/pm-data/CSCF_SQL.json     CSCF
