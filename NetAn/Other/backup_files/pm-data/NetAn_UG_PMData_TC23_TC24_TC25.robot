...
Documentation     Verify That The New Measure Is Present In PMA For 24.1 CCSM
...
Verify That The New Measure Is Present In PMA For 24.1 CCSM
    [Tags]       PMD_CDB
    ${json}=    OperatingSystem.get file    ./ENIQ_TC_Automation/NetAn/Resources/Data/pm-data/CCSM_PMA.json
