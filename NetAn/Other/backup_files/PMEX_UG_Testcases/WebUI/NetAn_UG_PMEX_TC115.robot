*** Settings ***
Documentation     Validate The Access Dropdown Is Added In Create Collection In Static Collection
...
Validate The Access Dropdown Is Added In Create Collection In Static Collection
