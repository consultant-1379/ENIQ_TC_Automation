*** Settings ***
Documentation     Verify Report Creation for Preceding period All selected and Collection 
...
Verify Report creation in PMEX for Preceding period All selected and Collection   
    [Tags]     PMEX         Report_Manager
    ${json}=    OperatingSystem.get file    ./ENIQ_TC_Automation/NetAn/Resources/Data/pm-explorer/PMEXWebUI_Preceding_Period_All_Selected_Collection.json
    &{object}=    Evaluate     json.loads('''${json}''')     json
    FOR   ${key}   IN  @{object.keys()}
        Run Keyword And Continue On Failure    Verify Report Creation for Preceding period All selected and Collection    ${Object}[${Key}] 
    END  


*** keywords ***

Verify Report Creation for Preceding period All selected and Collection 
    [Arguments]     ${data}
    ...
    Select Collections    ${data}[Collection]
