*** Settings ***
Documentation     Validate Report Generation For 'Advanced Options' In Select Time Panel
...
Validate Report Generation For 'Advanced Options' In Select Time Panel
    [TAGS]    PMEX_CDB    Report_Manager      NetAn_UG_PMEX_TC91
