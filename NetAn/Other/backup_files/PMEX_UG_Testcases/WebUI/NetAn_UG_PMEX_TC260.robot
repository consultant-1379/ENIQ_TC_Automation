...
Documentation     Verify Report Creation for Preceding period Collection and Collection
...
Verify Report creation in PMEX  
    [Tags]     PMEX          
    ${json}=    OperatingSystem.get file    ./ENIQ_TC_Automation/NetAn/Resources/Data/pm-explorer/PMEXWebUI_Preceding_Period_Collection_Collection.json
    &{object}=    Evaluate     json.loads('''${json}''')     json
    FOR   ${key}   IN  @{object.keys()}
        Run Keyword And Continue On Failure    Verify Report Creation for Preceding period Collection and Collection    ${Object}[${Key}] 
    END  


*** keywords ***

Verify Report Creation for Preceding period Collection and Collection 
    [Arguments]     ${data}
