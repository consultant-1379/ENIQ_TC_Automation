*** Settings ***
Documentation     Verify 'Create Information Link(s)' Page
...
Verify 'Create Information Link(s)' Page
	...
	enter the information link name    InfoLink
	verify that the button is present    Upto Parent Directory	
