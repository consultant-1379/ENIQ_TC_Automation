*** Settings ***
Documentation       Validate Report Generation For Custom KPI For Flex Counter
...
Validate Report Generation For Custom KPI For Flex Counter
    [Tags]    Custom_KPI           PMEX_CDB      NetAn_UG_PMEX_TC78
