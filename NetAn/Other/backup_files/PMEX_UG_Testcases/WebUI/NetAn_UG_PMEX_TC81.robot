*** Settings ***
Documentation       Validate Report Generation For Multiple Enhanced Custom KPIs
...
Validate Report Generation For Multiple Enhanced Custom KPIs
    [Tags]   Custom_KPI     PMEX_CDB       NetAn_UG_PMEX_TC81
    ...
    Select KPIs    EnhancedFlex1_KPI,EnhancedFlex2_KPI
    ...
    Verify saved report available in Report manager GUI   	  ${report_name}  	  Public  	 NA
