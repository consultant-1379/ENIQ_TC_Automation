...
class TestGetCollectionFromListScript(unittest.TestCase):
    def test_get_collectionList(self):
        time.sleep(5)                                                            
        run_get_collection_from_List()  
        

    def tearDown(self):
        clean_environment()
        
class TestGetCollectionListAfterDeletionScript(unittest.TestCase):
    def test_get_collectionList(self):
        time.sleep(5)                                                            
        run_get_collectionList_afterDelete()  
...
def run_check_button():
    FilterSelection = Document.Data.Filterings["OperationsFilteringScheme3"]
    dynCol = Document.FilteringSchemes[FilterSelection][Document.Data.Tables["Dynamiccollectontable"]]["OperationsForCollection"].As[filters.CheckBoxFilter]()
...
def run_get_collection_from_List():
    table=Document.Data.Tables['NodeCollection']
    cursor = DataValueCursor.CreateFormatted(table.Columns["CollectionName"])
    coltnName =coltnTitle
...
def run_get_collectionList_afterDelete():
    table=Document.Data.Tables['NodeCollection']
    cursor = DataValueCursor.CreateFormatted(table.Columns["CollectionName"])
...
def pmex_testing_suite():
    ...
    if testing_level ==  'Quick':
        ...
        test_suite.addTest(unittest.makeSuite(TestGetCollectionFromListScript))	
        test_suite.addTest(unittest.makeSuite(TestDeleteCollectionScript))	
        test_suite.addTest(unittest.makeSuite(TestGetCollectionListAfterDeletionScript))										 
    else:
        pass
