...
class TestNavToCollectionCreationScript(unittest.TestCase):
    def test_navTo_collectionCreation(self):
        set_test_case_from_json(params_for_fetch_value)   
        run_navTo_collectionCreation()
...
def run_navTo_collectionCreation():
...
def pmex_testing_suite():
    ...
    if testing_level == 'Full':
        ...
        test_suite.addTest(unittest.makeSuite(TestNavToCollectionCreationScript))
        
        # test_suite.addTest(unittest.makeSuite(TestLoadValueScript))
