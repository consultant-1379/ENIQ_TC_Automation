...
class TestAddRIMeasuresScript(unittest.TestCase):
    def test_add_rimeasures(self):
        time.sleep(20)           					   
        set_test_case_from_json(params_for_add_ri)
        tableName = "Measure Mapping"
        filterName = "AlarmRulesManagerFS"
        columnName = "Measure" 
        #variable
...
def pma_testing_suite():
    ...
    if testing_level == 'Full':
        ...
        test_suite.addTest(unittest.makeSuite(TestAddRIMeasuresScript))                
