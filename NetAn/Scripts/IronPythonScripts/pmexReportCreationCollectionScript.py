...
class TestPreviewClickScript(unittest.TestCase):
...
class TestAddCollectionScript(unittest.TestCase):
    def test_add_measures(self):
        set_test_case_from_json(params_for_fetch_nodes)      
        tableName = 'NodeCollection'
        filterName = "FilterSelectedCollection"
        columnName = "SelectedCollections"     
        #variable
        filterValues = coltnTitle
        #setListBoxFilter(tableName, "SubnetworkName", filterName,  filterValues)
        setListBoxFilter(tableName, columnName, filterName,  filterValues)
...
class TestDeletetReportScript(unittest.TestCase):    
...
def run_delete_report():
    scriptDef = clr.Reference[ScriptDefinition]()
    Document.ScriptManager.TryGetScript("DeleteReport", scriptDef)
    paramDict = {}
...
def pmex_testing_suite():
    ...
    if testing_level == 'Full':
        ...
        test_suite.addTest(unittest.makeSuite(TestPreviewClickScript))
        ...
        test_suite.addTest(unittest.makeSuite(TestAddCollectionScript))         
        ...
        test_suite.addTest(unittest.makeSuite(TestDeletetReportScript))
        test_suite.addTest(unittest.makeSuite(TestCollectionManagerClickScript))
