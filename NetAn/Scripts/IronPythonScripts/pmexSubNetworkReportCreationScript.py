...
class TestAddSubnetworkScript(unittest.TestCase):
    def test_add_measures(self):
        set_test_case_from_json(params_for_fetch_nodes)      
        tableName = 'SubNetwork List'
        filterName = "FilterSelectedCollection"
        columnName = "FilteredSubnetwork"     
        #variable
        filterValues = ["SUB_NETWORK"]
...
def pmex_testing_suite():
    ...
    if testing_level == 'Full':
        ...
        test_suite.addTest(unittest.makeSuite(TestAddSubnetworkScript))
