...
class TestReadValuesOfReportScript(unittest.TestCase):    
    def test_select_row(self):  
        run_read_values()
        time.sleep(30)
...
def run_select_row():
    #global alarmName
    # alarmName='test22Apr0707'
    alarmName = Document.Properties["AlarmName"]
    print("ALARM_NAME:")
    print(alarmName)
    #get the data table
    #table=Document.Data.Tables["test28Mar1312"]
...
def pmex_testing_suite():
    ...
    if testing_level == 'Full':
        ...
        test_suite.addTest(unittest.makeSuite(TestReadValuesOfReportScript))
