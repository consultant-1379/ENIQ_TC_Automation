...
class TestAddMeasure1Script(unittest.TestCase):
    def test_add_measures(self):
        set_test_case_from_json(params_for_add_measure1)
        tableName = "Measure Mapping"
...
class TestAddMeasure2Script(unittest.TestCase):
    def test_add_measures(self):
        time.sleep(20)           					   
        set_test_case_from_json(params_for_add_measure2)
        tableName = "Measure Mapping"
        filterName = "AlarmRulesManagerFS"
        columnName = "Measure" 
        #variable
...
class TestAddMeasure3Script(unittest.TestCase):
    def test_add_measures(self):
        time.sleep(20)           					   
        set_test_case_from_json(params_for_add_measure3)
        tableName = "Measure Mapping"
        filterName = "AlarmRulesManagerFS"
        columnName = "Measure" 
        #variable
...
def pma_testing_suite():
    ...
    if testing_level == 'Full':
        ...
        test_suite.addTest(unittest.makeSuite(TestAddMeasure1Script))
        test_suite.addTest(unittest.makeSuite(TestAddMeasure2Script))
        test_suite.addTest(unittest.makeSuite(TestAddMeasure3Script))                
