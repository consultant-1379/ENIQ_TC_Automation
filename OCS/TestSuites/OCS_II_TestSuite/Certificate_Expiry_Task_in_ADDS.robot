...
...              fetching the Certificate Expiry task details from Task Scheduler from the ADDS server
...
*** Test Cases ***
Certificate_Expiry_Check, Certificate_Expiry_Notification# Task check in ADDS
...
#Certificate_Expiry_Notification Task check in ADDS
