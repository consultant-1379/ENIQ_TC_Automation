*** Settings ***
Documentation    Test case to check the list of Ciphers disabled in the ADDS server and comparing with the expected output
...
*** Test Cases ***
Disabled Ciphers Details in ADDS
