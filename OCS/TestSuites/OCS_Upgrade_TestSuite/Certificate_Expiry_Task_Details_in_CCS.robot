...
...              Certificate_Expiry_Notification tasks from Task Scheduler from the CCS server
...
*** Test Cases ***
Certificate_Expiry_Check_Task, Certificate_Expiry_Notification_Task check in CCS
...
#Certificate_Expiry_Notification_Task check in CCS
