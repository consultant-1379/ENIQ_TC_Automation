...
...              Certificate_Expiry_Notification tasks from Task Scheduler from the VDA server
...
*** Test Cases ***
Certificate_Expiry_Check_Task, Certificate_Expiry_Notification_Task check in VDA
...
#Certificate_Expiry_Notification_Task check in VDA
