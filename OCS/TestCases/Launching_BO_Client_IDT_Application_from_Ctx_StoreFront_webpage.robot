...
*** Test Cases ***
Launching BO Client IDT Application from Citrix StoreFront webpage
    Launch Citrix StoreFront webpage
    Enter Username and Password
    Signin to the Citrix StoreFront webpage
    Go to Apps tab
    Launch IDT Designer App
    Close IDT Designer App
...
Launch IDT Designer App
    Click    BO_Client_IDT_Icon_from_Ctx_StoreFront_webpage.PNG
    Sleep    10
    Click    ICA_Icon_Button_Downloaded.PNG
    Sleep    10
    Wait Until Screen Contain   BO_Client_IDT_App2_from_Ctx_StoreFront_webpage.PNG    40
    #Capture Page Screenshot

Close IDT Designer App
    #Click    BO_Client_IDT_App_Cancel_Button.PNG
    #Click    BO_Client_IDT_App_File_Menu.PNG
    Click    BO_Client_IDT_App_File_Menu2.PNG
    Sleep    3
    Click    BO_Client_IDT_Exit_Menu.PNG
